...
_080A542C:
	...
	cmp r0, #0
	ble _080A5474
	ldr r4, _080A546C @ =gUnk_02023530
	adds r0, r5, #0
	adds r0, #0x56
	ldrb r0, [r0]
	mov sb, r0
	...
	b _080A54AA
	.align 2, 0
_080A546C: .4byte gUnk_02023530
_080A5470: .4byte 0xFFFFF800
_080A5474:
	cmp r0, #0
	bge _080A54DC
	ldr r4, _080A5550 @ =gUnk_02023530
	adds r0, r5, #0
	adds r0, #0x56
	ldrb r0, [r0]
	mov sb, r0
...
_080A5558:
	...
	adds r1, r0, r4
	ldr r4, _080A5614 @ =gUnk_02023530
	adds r0, r5, #0
	adds r0, #0x56
	ldrb r0, [r0]
	mov sb, r0
...
_080A57AE:
	...
	str r0, [r5, #8]
_080A57CC:
	ldr r3, _080A582C @ =gUnk_02023530
	adds r0, r5, #0
	adds r0, #0x56
	ldrb r0, [r0]
	mov sb, r0
...
_080A5A5E:
	...
	b _080A5B02
_080A5A66:
	ldr r3, _080A5B10 @ =gUnk_02023530
	adds r0, r5, #0
	adds r0, #0x56
	ldrb r0, [r0]
	mov sb, r0
...
_080A5B68:
	...
	cmp r0, #0
	bne _080A5C0E
	ldr r3, _080A5C38 @ =gUnk_02023530
	adds r0, r4, #0
	adds r0, #0x56
	ldrb r0, [r0]
	mov sb, r0
...
_080A5C72:
	...
	strh r0, [r1]
_080A5C92:
	ldr r3, _080A5D3C @ =gUnk_02023530
	adds r1, r5, #0
	adds r1, #0x56
	ldrb r0, [r1]
	mov sl, r0
...
_080A5D48:
	...
	adds r0, r0, r1
	asrs r1, r0, #0xc
	ldr r4, _080A5D74 @ =gUnk_02023530
	ldr r2, [sp]
	ldrb r6, [r2]
	b _080A5D90
	.align 2, 0
_080A5D70: .4byte gUnk_082D88B8
_080A5D74: .4byte gUnk_02023530
_080A5D78:
	cmp r2, #0
	bge _080A5DEC
	...
	adds r0, r0, r4
	asrs r1, r0, #0xc
	ldr r4, _080A5E2C @ =gUnk_02023530
	ldr r0, [sp]
	ldrb r6, [r0]
_080A5D90:
	movs r0, #0xcd
...
_080A5FBA:
	...
	strh r1, [r4, #4]
_080A5FDA:
	ldr r3, _080A6038 @ =gUnk_02023530
	adds r0, r4, #0
	adds r0, #0x56
	ldrb r0, [r0]
	mov sb, r0
...
_080A626A:
	...
	ldrh r0, [r2]
	strh r0, [r4, #4]
	ldr r3, _080A6340 @ =gUnk_02023530
	adds r0, r4, #0
	adds r0, #0x56
	ldrb r0, [r0]
	mov sl, r0
...
sub_080A63A0: @ 0x080A63A0
	...
	strh r0, [r2]
_080A63C6:
	ldr r3, _080A6488 @ =gUnk_02023530
	adds r0, r4, #0
	adds r0, #0x56
	ldrb r0, [r0]
	mov sb, r0
...
sub_080A64F0: @ 0x080A64F0
	...
	strh r0, [r2]
_080A6516:
	ldr r3, _080A65D8 @ =gUnk_02023530
	adds r0, r4, #0
	adds r0, #0x56
	ldrb r0, [r0]
	mov sb, r0
...
sub_080A6704: @ 0x080A6704
	...
	strh r0, [r2]
_080A672A:
	ldr r3, _080A67EC @ =gUnk_02023530
	adds r0, r4, #0
	adds r0, #0x56
	ldrb r0, [r0]
	mov sb, r0
...
sub_080A6914: @ 0x080A6914
	...
	strh r0, [r2]
_080A693A:
	ldr r3, _080A69FC @ =gUnk_02023530
	adds r0, r4, #0
	adds r0, #0x56
	ldrb r0, [r0]
	mov sb, r0
...
sub_080A6AE8: @ 0x080A6AE8
	...
	strh r0, [r2]
_080A6B0E:
	ldr r3, _080A6BD0 @ =gUnk_02023530
	adds r0, r4, #0
	adds r0, #0x56
	ldrb r0, [r0]
	mov sb, r0
...
_080A6DC8:
	...
	movs r3, #0
	strb r3, [r5]
	ldr r2, _080A6E2C @ =gUnk_02020EE0
...
_080A6E74:
	...
	b _080A711C
_080A6E8A:
	ldr r2, _080A6EF0 @ =gUnk_02020EE0
...
_080A6F54:
	...
	str r0, [r5, #0x14]
_080A6F5E:
	ldr r2, _080A6FA4 @ =gUnk_02020EE0
...
_080A6FB8:
	...
	cmp r0, #0
	beq _080A7004
	ldr r1, _080A706C @ =gUnk_02023530
	mov sb, r1
	ldrh r3, [r7]
...
_080A706C: .4byte gUnk_02023530
_080A7070: .4byte gUnk_02026D50
_080A7074:
	adds r4, r5, #0
	movs r3, #0
	ldr r2, _080A70D8 @ =gUnk_02020EE0
	adds r0, r2, #0
	adds r0, #0x60
	ldrh r0, [r0]
	ldrh r1, [r7]
