...
_08033950:
	...
	bl CpuSet
	ldr r4, _08033988 @ =gLocalPlayerId
	ldrb r1, [r4]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_08033988: .4byte gLocalPlayerId
...
_08033A3A:
	...
	mov ip, r3
_08033A4C:
	ldr r4, _08033AA8 @ =gLocalPlayerId
	ldrb r0, [r4]
	cmp r0, r7
	bne _08033AB0
	lsls r2, r7, #2
...
_08033AA8: .4byte gLocalPlayerId
...
_08033BCC:
	adds r5, r0, #0
	ldr r0, _08033C7C @ =gLocalPlayerId
	ldrb r0, [r0]
	movs r7, #0xd4
	lsls r7, r7, #1
	muls r0, r7, r0
...
_08033C76:
	...
	b _08033C96
	.align 2, 0
_08033C7C: .4byte gLocalPlayerId
...
_08033CFA:
	...
	ldr r0, _08033D98 @ =gLocalPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_08033D98: .4byte gLocalPlayerId
...
_08033E14:
	...
	bhi _08033EB2
_08033E24:
	ldr r0, _08033E70 @ =gLocalPlayerId
	ldrb r1, [r0]
	lsls r0, r1, #2
	adds r0, r0, r1
	lsls r0, r0, #3
	...
	b _08033E8A
	.align 2, 0
_08033E70: .4byte gLocalPlayerId
...
_08033EC2:
	...
	adds r0, r6, #0
	adds r0, #0x56
	ldr r1, _08033F18 @ =gLocalPlayerId
	ldrb r0, [r0]
	ldrb r1, [r1]
	cmp r0, r1
	bne _08033EE2
...
_08033F02:
	...
	b _08033F2C
	.align 2, 0
_08033F18: .4byte gLocalPlayerId
_08033F1C:
	cmp r0, #1
	bne _08033F2C
	ldrb r0, [r5, #0xd]
...
sub_08034034: @ 0x08034034
	...
	cmp r3, r0
	bhs _08034094
	ldr r7, _080340A0 @ =gLocalPlayerId
	movs r6, #0xd4
	lsls r6, r6, #1
...
_080340A0: .4byte gLocalPlayerId
...
_080340D8:
	adds r6, r0, #0
	ldr r0, _08034104 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r1, r0, r1
	...
	b _08034114
	.align 2, 0
_08034104: .4byte gLocalPlayerId
...
_08034242:
	...
	ldr r0, _080342B4 @ =gLocalPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_080342B4: .4byte gLocalPlayerId
...
_080342C4:
	...
	adds r0, r7, #0
	adds r0, #0x56
	ldr r1, _08034300 @ =gLocalPlayerId
	ldrb r0, [r0]
	ldrb r1, [r1]
	cmp r0, r1
	bne _080342E4
...
_080342F2:
	...
	bx r0
	.align 2, 0
_08034300: .4byte gLocalPlayerId
...
sub_08034304: @ 0x08034304
	...
	b _08034804
_0803431A:
	ldr r1, _080343AC @ =gLocalPlayerId
	ldrb r1, [r1]
	cmp sb, r1
	bne _08034324
	b _080347FA
_08034324:
	...
	mov r3, sl
	adds r5, r3, r0
	ldr r3, _080343AC @ =gLocalPlayerId
	ldrb r0, [r3]
	muls r0, r2, r0
	adds r0, r0, r1
	adds r0, #0x60
...
_08034370:
	...
	b _080345B8
_08034380:
	ldr r0, _080343AC @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xcd
	lsls r0, r0, #3
	muls r1, r0, r1
	...
	b _080343CC
	.align 2, 0
_080343AC: .4byte gLocalPlayerId
...
sub_08034A20: @ 0x08034A20
	...
	mov r6, r8
	push {r6, r7}
	ldr r0, _08034B28 @ =gLocalPlayerId
	mov r8, r0
	ldrb r0, [r0]
	movs r6, #0xd4
	lsls r6, r6, #1
...
_08034B64:
	...
	ldr r0, _08034B98 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_08034B98: .4byte gLocalPlayerId
_08034B9C:
	bl sub_080361B0
_08034BA0:
	mov r0, sb
...
_08034E40:
	...
	ldr r0, _08034EB4 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_08034EB4: .4byte gLocalPlayerId
_08034EB8:
	adds r0, r3, #0
	adds r0, #0x80
	movs r1, #0
	...
	ldr r0, _08034F34 @ =gNumHumanPlayers
	ldrb r1, [r0]
	subs r1, #1
	lsls r1, r1, #1
	mov r0, ip
...
_08034F34: .4byte gNumHumanPlayers
_08034F38:
	mov r0, ip
	adds r0, #0x80
	movs r2, #0
	...
	ldr r0, _08034F64 @ =gNumHumanPlayers
	ldrb r1, [r0]
	subs r1, #1
	lsls r1, r1, #1
	ldrb r0, [r4]
...
_08034F64: .4byte gNumHumanPlayers
_08034F68:
	mov r0, ip
	adds r0, #0x80
	movs r1, #0
...
_08034FE0:
	...
	mov r8, r3
	ldr r5, _080350D0 @ =gLocalPlayerId
	ldrb r0, [r5]
	movs r4, #0xd4
	lsls r4, r4, #1
	muls r0, r4, r0
...
_080350D0: .4byte gLocalPlayerId
...
_08035354:
	...
	ldr r0, _08035384 @ =gNumHumanPlayers
	ldrb r1, [r0]
	subs r1, #1
	lsls r1, r1, #1
	adds r0, r5, #0
...
_08035384: .4byte gNumHumanPlayers
_08035388:
	movs r2, #0
	ldrsh r3, [r1, r2]
	ldr r2, _080353AC @ =gUnk_08351458
	ldr r0, _080353B0 @ =gNumHumanPlayers
	ldrb r1, [r0]
	subs r1, #1
	lsls r1, r1, #1
	ldrb r0, [r4]
...
_080353B0: .4byte gNumHumanPlayers
_080353B4:
	movs r5, #0
	ldrsh r2, [r1, r5]
...
_08035428:
	...
	ldr r2, _08035470 @ =gLocalPlayerId
	ldrb r5, [r2]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r5, r0
...
_08035470: .4byte gLocalPlayerId
...
sub_0803557C: @ 0x0803557C
	...
	ldrb r6, [r0, #4]
	ldr r1, _080355EC @ =gLocalPlayerId
	movs r0, #1
	ldrb r1, [r1]
	lsls r0, r1
	movs r1, #0x10
...
_080355EC: .4byte gLocalPlayerId
...
_0803560E:
	...
	ldr r0, _08035698 @ =gLocalPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_08035698: .4byte gLocalPlayerId
...
sub_08035788: @ 0x08035788
	...
	ldr r0, _080357C8 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_080357C8: .4byte gLocalPlayerId
...
_080357D8:
	...
	ldr r0, _08035860 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_08035908:
	...
	mov sl, r0
	ldr r7, _08035964 @ =gLocalPlayerId
	ldrb r0, [r7]
	movs r6, #0xd4
	lsls r6, r6, #1
	muls r0, r6, r0
...
_080359B2:
	...
	adds r0, r3, #0
	strh r0, [r1]
	ldr r0, _08035AB4 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_08035A08:
	...
	cmp r3, #1
	bls _08035A08
	ldr r6, _08035AB4 @ =gLocalPlayerId
	ldrb r0, [r6]
	movs r5, #0xd4
	lsls r5, r5, #1
	muls r0, r5, r0
...
_08035AB4: .4byte gLocalPlayerId
...
_08035AEE:
	strh r0, [r1]
	ldr r0, _08035B64 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_08035B64: .4byte gLocalPlayerId
...
_08035D18:
	...
	bhi _08035DB4
_08035D2A:
	ldr r0, _08035D84 @ =gLocalPlayerId
	ldrb r1, [r0]
	lsls r0, r1, #2
	adds r0, r0, r1
	lsls r0, r0, #3
...
_08035D84: .4byte gLocalPlayerId
...
_08035E6C:
	...
	adds r0, r4, #0
	adds r0, #0x56
	ldr r1, _08035E98 @ =gLocalPlayerId
	ldrb r0, [r0]
	ldrb r1, [r1]
	cmp r0, r1
	bne _08035E8E
...
_08035E98: .4byte gLocalPlayerId
...
_08035EC8:
	...
	adds r0, r3, #0
	adds r0, #0x56
	ldr r1, _08035EF4 @ =gLocalPlayerId
	ldrb r0, [r0]
	ldrb r1, [r1]
	cmp r0, r1
	bne _08035EEC
...
_08035EF4: .4byte gLocalPlayerId
...
_08035F24:
	...
	adds r0, r3, #0
	adds r0, #0x56
	ldr r1, _08035F4C @ =gLocalPlayerId
	ldrb r0, [r0]
	ldrb r1, [r1]
	cmp r0, r1
	bne _08035F42
...
_08035F4C: .4byte gLocalPlayerId
...
_08035F7C:
	...
	adds r0, r3, #0
	adds r0, #0x56
	ldr r1, _08035FA4 @ =gLocalPlayerId
	ldrb r0, [r0]
	ldrb r1, [r1]
	cmp r0, r1
	bne _08035F9A
...
_08035FA4: .4byte gLocalPlayerId
...
sub_08035FDC: @ 0x08035FDC
	...
	ldr r0, _08036030 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
sub_08036114: @ 0x08036114
	...
	ldr r0, _08036174 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
sub_080362A4: @ 0x080362A4
	...
	str r0, [r1, #8]
	ldr r0, _0803630C @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_0803630C: .4byte gLocalPlayerId
...
sub_08036314: @ 0x08036314
	...
	mov r0, sp
	bl CpuSet
	ldr r0, _08036370 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_08036370: .4byte gLocalPlayerId
...
_08036626:
	...
	adds r0, r7, #0
	adds r0, #0x56
	ldr r1, _080366B0 @ =gLocalPlayerId
	ldrb r0, [r0]
	ldrb r1, [r1]
	cmp r0, r1
	bne _08036646
...
_080366A4:
	...
	b _08036990
	.align 2, 0
_080366B0: .4byte gLocalPlayerId
_080366B4:
	adds r0, r7, #0
	adds r0, #0x56
	ldr r1, _08036750 @ =gNumHumanPlayers
	ldrb r2, [r0]
	ldrb r3, [r1]
	mov r8, r0
	cmp r2, r3
...
_08036720:
	...
	b _08036766
	.align 2, 0
_08036750: .4byte gNumHumanPlayers
...
_08037148:
	...
	ldr r0, _080371F8 @ =gLocalPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_080371F8: .4byte gLocalPlayerId
...
_0803720C:
	...
	ldr r0, _08037300 @ =gLocalPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_08037300: .4byte gLocalPlayerId
...
_08038D14:
	mov r1, sb
	adds r1, #0x56
	ldr r0, _08038D70 @ =gNumHumanPlayers
	ldrb r1, [r1]
	ldrb r2, [r0]
	cmp r1, r2
	blo _08038D32
...
_08038D70: .4byte gNumHumanPlayers
_08038D74:
...
_08038E5A:
	mov r1, sb
	adds r1, #0x56
	ldr r0, _08038EA0 @ =gNumHumanPlayers
	ldrb r1, [r1]
	ldrb r2, [r0]
	cmp r1, r2
	blo _08038E76
...
_08038EA0: .4byte gNumHumanPlayers
_08038EA4:
	adds r1, r7, #0
	adds r1, #0x62
	ldrb r2, [r1]
...
sub_08039504: @ 0x08039504
	...
	beq _08039588
	movs r3, #0
	ldr r4, _08039578 @ =gNumHumanPlayers
...
_08039578: .4byte gNumHumanPlayers
...
sub_08039F38: @ 0x08039F38
	...
	bx r0
	.align 2, 0
_08039F68: .4byte gLocalPlayerId
...
_0803C862:
	...
	ldr r0, _0803C8C4 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_0803C8C4: .4byte gLocalPlayerId
...
_0803C8F2:
	...
	ldr r0, _0803C954 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_0803C954: .4byte gLocalPlayerId
...
_0803C9AC:
	...
	ldr r0, _0803CA18 @ =gLocalPlayerId
	ldrb r0, [r0]
	movs r2, #0xd4
	lsls r2, r2, #1
	adds r1, r0, #0
...
_0803CA18: .4byte gLocalPlayerId
...
_0803CA70:
	...
	ldr r0, _0803CADC @ =gLocalPlayerId
	ldrb r0, [r0]
	movs r2, #0xd4
	lsls r2, r2, #1
	adds r1, r0, #0
...
_0803CADC: .4byte gLocalPlayerId
...
sub_0803CB64: @ 0x0803CB64
	...
	ldr r0, _0803CBC0 @ =gLocalPlayerId
	ldrb r0, [r0]
	movs r2, #0xd4
	lsls r2, r2, #1
	adds r1, r0, #0
...
_0803CBC0: .4byte gLocalPlayerId
...
_0803CC14:
	...
	ldr r0, _0803CC7C @ =gLocalPlayerId
	ldrb r0, [r0]
	movs r2, #0xd4
	lsls r2, r2, #1
	adds r1, r0, #0
...
_0803CC7C: .4byte gLocalPlayerId
...
_0803CCD0:
	...
	ldr r0, _0803CD3C @ =gLocalPlayerId
	ldrb r0, [r0]
	movs r2, #0xd4
	lsls r2, r2, #1
	adds r1, r0, #0
...
_0803CD3C: .4byte gLocalPlayerId
...
_0803CD48:
	...
	cmp r0, #0
	beq _0803CD7C
	ldr r0, _0803CD94 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_0803CD94: .4byte gLocalPlayerId
