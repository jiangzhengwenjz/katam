...
_0809F3FE:
	...
	movs r7, #0x1d
_0809F40C:
	ldr r0, _0809F45C @ =gUnk_08351648
	mov ip, r0
	ldrb r3, [r6]
	lsls r0, r3, #1
	adds r0, r0, r3
	...
	b _0809F5CC
_0809F426:
	ldr r2, _0809F460 @ =gUnk_02020EE0
	ldr r0, _0809F464 @ =gUnk_0203AD3C
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_0809F446:
	...
	b _0809F46E
	.align 2, 0
_0809F45C: .4byte gUnk_08351648
_0809F460: .4byte gUnk_02020EE0
_0809F464: .4byte gUnk_0203AD3C
_0809F468:
	adds r0, r4, #0
	bl sub_081570B0
_0809F46E:
	...
	movs r3, #0
	strh r0, [r5, #0x24]
	ldr r6, _0809F528 @ =gUnk_08351648
	movs r2, #0x82
	adds r2, r2, r5
	mov ip, r2
	ldrb r1, [r2]
...
_0809F4E4:
	...
	cmp r0, #0xff
	bne _0809F536
	ldr r2, _0809F52C @ =gUnk_02020EE0
	ldr r0, _0809F530 @ =gUnk_0203AD3C
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
	...
	b _0809F536
	.align 2, 0
_0809F528: .4byte gUnk_08351648
_0809F52C: .4byte gUnk_02020EE0
_0809F530: .4byte gUnk_0203AD3C
_0809F534:
	movs r0, #0
_0809F536:
	adds r1, r5, #0
...
nullsub_124: @ 0x0809F9BC
	...
	thumb_func_start CreateGordo
CreateGordo: @ 0x0809F9C0
	push {r4, r5, r6, lr}
	sub sp, #4
	adds r6, r0, #0
	lsls r1, r1, #0x18
	lsrs r4, r1, #0x18
	ldr r0, _0809F9F4 @ =ObjectMain
	movs r2, #0x80
	lsls r2, r2, #5
	ldr r1, _0809F9F8 @ =ObjectDestroy
	str r1, [sp]
	movs r1, #0xb4
	movs r3, #0x10
	bl TaskCreate
	...
	b _0809FA04
	.align 2, 0
_0809F9F4: .4byte ObjectMain
_0809F9F8: .4byte ObjectDestroy
_0809F9FC:
	ldrh r1, [r2, #6]
	movs r0, #0xc0
	lsls r0, r0, #0x12
...
_0809FA7E:
	...
	b _0809FAA6
	.align 2, 0
_0809FA88: .4byte 0x00008040
_0809FA8C: .4byte 0x00400020
_0809FA90:
	adds r0, r5, #0
	bl sub_0809FC8C
	b _0809FAA6
...
_0809FAEC:
	...
	thumb_func_start sub_0809FAF8
sub_0809FAF8: @ 0x0809FAF8
	push {lr}
	adds r2, r0, #0
	ldr r0, [r2, #8]
	movs r1, #4
...
_0809FB26:
	...
	thumb_func_start sub_0809FB3C
sub_0809FB3C: @ 0x0809FB3C
	push {r4, lr}
	adds r2, r0, #0
	ldr r0, [r2, #8]
	movs r3, #4
	orrs r0, r3
	str r0, [r2, #8]
	ldr r1, _0809FB7C @ =gUnk_08352E04
	movs r4, #4
	ldrsh r0, [r2, r4]
	lsls r0, r0, #1
	adds r0, r0, r1
...
_0809FFBC:
	...
	ldr r0, [r5, #0x40]
	adds r6, r0, r1
	ldr r4, _080A00A4 @ =gUnk_02023530
	adds r1, r5, #0
	adds r1, #0x56
	ldrb r7, [r1]
	movs r0, #0xcd
...
_080A0192:
	...
	ldr r0, [r5, #0x40]
	adds r6, r0, r1
	ldr r4, _080A0278 @ =gUnk_02023530
	adds r1, r5, #0
	adds r1, #0x56
	ldrb r7, [r1]
	movs r0, #0xcd
...
_080A0B24:
	...
	cmp r0, #0xff
	beq _080A0B5C
	ldr r2, _080A0B54 @ =gUnk_02023530
	adds r1, r0, #0
	movs r0, #0xcd
	lsls r0, r0, #3
	muls r0, r1, r0
...
_080A138A:
	...
	ldr r1, [r5, #0x40]
	adds r1, r1, r0
	ldr r4, _080A1400 @ =gUnk_02023530
	adds r0, r5, #0
	adds r0, #0x56
	ldrb r6, [r0]
	movs r0, #0xcd
...
_080A1458:
	...
	ldr r1, [r5, #0x40]
	adds r1, r1, r0
	ldr r4, _080A14CC @ =gUnk_02023530
	adds r0, r5, #0
	adds r0, #0x56
	ldrb r6, [r0]
	movs r0, #0xcd
...
_080A173A:
	...
	ldr r1, [r5, #0x40]
	adds r1, r1, r0
	ldr r4, _080A17CC @ =gUnk_02023530
	adds r0, r5, #0
	adds r0, #0x56
	ldrb r6, [r0]
	movs r0, #0xcd
...
_080A212C:
	...
	cmp r0, #0xff
	beq _080A2164
	ldr r2, _080A215C @ =gUnk_02023530
	adds r1, r0, #0
	movs r0, #0xcd
	lsls r0, r0, #3
	muls r0, r1, r0
...
sub_080A389C: @ 0x080A389C
	...
	ands r0, r1
	str r0, [r4, #8]
	ldr r2, _080A3920 @ =gUnk_02023530
	adds r0, r4, #0
	adds r0, #0x56
	ldrb r1, [r0]
	movs r0, #0xcd
