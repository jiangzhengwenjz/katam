	...
	thumb_func_start CreateDoorToHub
CreateDoorToHub: @ 0x0802AAF8
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
sub_0802AD00: @ 0x0802AD00
	...
	ldr r0, [r0]
	ldrb r1, [r0, #4]
	ldr r3, _0802AD94 @ =gCurLevelInfo
	adds r4, r5, #0
	adds r4, #0x56
	ldrb r2, [r4]
	movs r0, #0xcd
...
_0802AEC0:
	...
	lsls r0, r0, #3
	muls r0, r1, r0
	ldr r1, _0802B070 @ =gCurLevelInfo
	mov sb, r1
	add r0, sb
	mov ip, r0
	adds r0, r7, #0
...
_0802AF94:
	...
	lsls r0, r0, #3
	muls r0, r1, r0
	ldr r3, _0802B070 @ =gCurLevelInfo
	adds r4, r0, r3
	movs r2, #0
	ldr r0, _0802B074 @ =gUnk_0203AD30
	ldrb r1, [r0]
...
_0802B05E:
	...
	bx r0
	.align 2, 0
_0802B070: .4byte gCurLevelInfo
_0802B074: .4byte gUnk_0203AD30
_0802B078: .4byte gKirbys
...
_0802B1C4: .4byte sub_0802AE9C
	...
	thumb_func_start CreateAreaDoor
CreateAreaDoor: @ 0x0802B1C8
	push {r4, r5, r6, r7, lr}
	sub sp, #4
	adds r4, r0, #0
	lsls r1, r1, #0x18
