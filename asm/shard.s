...
sub_0801BB10: @ 0x0801BB10
	...
	lsls r0, r0, #3
	muls r1, r0, r1
	ldr r0, _0801BB80 @ =gCurLevelInfo
	adds r1, r1, r0
	movs r4, #0
...
_0801BB32:
	...
	ble _0801BB7C
_0801BB5E:
	ldr r1, _0801BB80 @ =gCurLevelInfo
	movs r0, #0xcd
	lsls r0, r0, #3
	muls r0, r4, r0
	adds r0, r0, r1
...
_0801BB7C:
	...
	b _0801BB9C
	.align 2, 0
_0801BB80: .4byte gCurLevelInfo
_0801BB84: .4byte gUnk_0203AD30
_0801BB88: .4byte gKirbys
_0801BB8C:
	adds r0, r4, #1
	lsls r0, r0, #0x10
	lsrs r4, r0, #0x10
...
_0801BE84:
	...
	lsls r0, r0, #3
	muls r0, r1, r0
	ldr r7, _0801BFD4 @ =gCurLevelInfo
	mov sl, r7
	add r0, sl
	mov ip, r0
	mov r0, r8
...
_0801BF5C:
	...
	cmp r7, r0
	bhs _0801BFCA
	ldr r6, _0801BFD4 @ =gCurLevelInfo
_0801BF72:
	ldr r1, _0801BFDC @ =gKirbys
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r7, r0
	adds r5, r0, r1
...
_0801BFCA:
	...
	b _0801BFF4
	.align 2, 0
_0801BFD4: .4byte gCurLevelInfo
_0801BFD8: .4byte gUnk_0203AD30
_0801BFDC: .4byte gKirbys
