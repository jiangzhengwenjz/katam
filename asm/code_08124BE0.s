...
sub_081254A8: @ 0x081254A8
	...
	mov r7, r8
	push {r7}
	ldr r0, _081254C8 @ =gCurGameState
	ldr r2, [r0]
	ldrh r1, [r2, #0x12]
	movs r0, #0x10
	ands r0, r1
...
_08125560:
	...
	bl m4aSongNumStart
	ldr r0, _08125600 @ =gCurGameState
	ldr r1, [r0]
