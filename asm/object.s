...
_0809A20A:
	...
	cmp r0, #2
	bhi _0809A27C
	ldr r2, _0809A334 @ =gCurLevelInfo
	ldrb r1, [r6]
	movs r0, #0xcd
	lsls r0, r0, #3
	muls r0, r1, r0
...
_0809A4B2:
	...
	ldrb r0, [r1, #2]
	ldrb r1, [r1, #3]
	ldr r4, _0809A4D4 @ =gCurLevelInfo
	ldrb r3, [r6]
	movs r2, #0xcd
	lsls r2, r2, #3
	muls r2, r3, r2
...
_0809A516:
	...
	cmp r0, #0
	bgt _0809A554
	ldr r2, _0809A578 @ =gCurLevelInfo
	ldrb r1, [r6]
	movs r0, #0xcd
	lsls r0, r0, #3
	muls r0, r1, r0
...
_0809A8CC:
	...
	ldr r2, [r7, #0x40]
	asrs r2, r2, #8
	ldr r4, _0809A974 @ =gCurLevelInfo
	movs r5, #0xcd
	lsls r5, r5, #3
	adds r0, r3, #0
	muls r0, r5, r0
