...
sub_080B5D70: @ 0x080B5D70
	...
	ldr r0, _080B5E08 @ =gCurrentPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_080B5E08: .4byte gCurrentPlayerId
...
_080B5E86:
	...
	ldr r0, _080B5F04 @ =gCurrentPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_080B5F04: .4byte gCurrentPlayerId
...
_080B6012:
	...
	ldr r0, _080B6098 @ =gCurrentPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_080B6098: .4byte gCurrentPlayerId
...
_080B63BC:
	...
	ldr r0, _080B6448 @ =gCurrentPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_080B6448: .4byte gCurrentPlayerId
