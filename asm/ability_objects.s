...
sub_080A9258: @ 0x080A9258
	...
	cmp r0, #0
	bne _080A92B8
	ldr r2, _080A9328 @ =gCurLevelInfo
	adds r3, r4, #0
	adds r3, #0x56
	ldrb r1, [r3]
	movs r0, #0xcd
...
_080A931E:
	...
	b _080A9772
	.align 2, 0
_080A9328: .4byte gCurLevelInfo
_080A932C: .4byte 0x00000292
_080A9330: .4byte gKirbys
...
_080A93EC:
	...
	ands r0, r1
	str r0, [r4, #8]
	ldr r3, _080A9494 @ =gCurLevelInfo
	mov sl, r3
	ldr r3, [r4, #0x40]
_080A93FC:
	adds r0, r4, #0
...
_080A948C:
	...
	b _080A94B4
	.align 2, 0
_080A9494: .4byte gCurLevelInfo
_080A9498: .4byte gKirbys
...
_080A94B4:
	...
	orrs r0, r1
	str r0, [r4, #8]
	ldr r3, _080A956C @ =gCurLevelInfo
	mov sl, r3
_080A94C0:
	adds r0, r4, #0
	adds r0, #0x3d
...
_080A9564:
	...
	b _080A9618
	.align 2, 0
_080A956C: .4byte gCurLevelInfo
_080A9570: .4byte 0xFFFFF800
_080A9574: .4byte gKirbys
...
_080A99FC:
	...
	cmp r0, #0x1a
	beq _080A9AE0
	ldr r1, _080A9AEC @ =gCurLevelInfo
	adds r3, r4, #0
	adds r3, #0x56
	ldrb r2, [r3]
	movs r0, #0xcd
...
_080A9AEC: .4byte gCurLevelInfo
_080A9AF0: .4byte 0x00000103
_080A9AF4: .4byte 0x00000292
_080A9AF8: .4byte gKirbys
...
_080A9D66:
	...
	lsrs r5, r1, #0x10
	asrs r1, r1, #0x10
	ldr r0, _080A9DB4 @ =gCurLevelInfo
	mov r8, r0
	adds r0, r2, #0
	adds r0, #0x56
	ldrb r2, [r0]
...
_080A9DC0:
	...
	lsrs r4, r1, #0x10
	asrs r1, r1, #0x10
	ldr r0, _080A9E08 @ =gCurLevelInfo
	mov r8, r0
	adds r0, r2, #0
	adds r0, #0x56
	ldrb r2, [r0]
...
_080A9E14:
	...
	lsrs r5, r1, #0x10
	asrs r1, r1, #0x10
	ldr r0, _080A9E98 @ =gCurLevelInfo
	mov r8, r0
	adds r0, r2, #0
	adds r0, #0x56
	ldrb r2, [r0]
...
_080A9ED8:
	...
	lsrs r4, r1, #0x10
	asrs r1, r1, #0x10
	ldr r0, _080A9F64 @ =gCurLevelInfo
	mov r8, r0
	adds r0, r2, #0
	adds r0, #0x56
	ldrb r2, [r0]
...
_080AA228:
	...
	orrs r2, r1
	strh r2, [r5, #6]
	ldr r3, _080AA294 @ =gCurLevelInfo
	mov ip, r3
	adds r0, r7, #0
	adds r0, #0x56
	ldrb r1, [r0]
