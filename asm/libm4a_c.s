...
sub_08E8D5F0: @ 0x08E8D5F0
	...
	movs r0, #0x77
	strb r0, [r3]
	ldr r0, _08E8D6C4 @ =gUnk_03007FF0
	ldr r4, [r0]
	ldr r6, [r4]
...
_08E8D75E:
	...
	str r0, [r1]
	ldr r0, _08E8D814 @ =gUnk_03007FF0
	str r5, [r0]
	str r3, [sp]
...
sub_08E8D82C: @ 0x08E8D82C
	push {r4, r5, r6, lr}
	adds r2, r0, #0
	ldr r0, _08E8D8AC @ =gUnk_03007FF0
	ldr r4, [r0]
	movs r0, #0xf0
	lsls r0, r0, #0xc
	ands r0, r2
...
sub_08E8D8D0: @ 0x08E8D8D0
	push {r4, r5, lr}
	adds r3, r0, #0
	ldr r0, _08E8D95C @ =gUnk_03007FF0
	ldr r5, [r0]
	ldr r1, [r5]
...
sub_08E8D968: @ 0x08E8D968
	push {r4, r5, r6, r7, lr}
	ldr r0, _08E8D9B4 @ =gUnk_03007FF0
	ldr r6, [r0]
	ldr r1, [r6]
...
sub_08E8D9BC: @ 0x08E8D9BC
	push {lr}
	sub sp, #4
	ldr r0, _08E8DA1C @ =gUnk_03007FF0
	ldr r2, [r0]
	ldr r1, [r2]
...
sub_08E8DA38: @ 0x08E8DA38
	push {r4, lr}
	ldr r0, _08E8DA68 @ =gUnk_03007FF0
	ldr r2, [r0]
	ldr r3, [r2]
...
sub_08E8DA74: @ 0x08E8DA74
	...
	movs r4, #0x10
_08E8DA88:
	ldr r0, _08E8DAE0 @ =gUnk_03007FF0
	ldr r5, [r0]
	ldr r1, [r5]
...
sub_08E8DEEC: @ 0x08E8DEEC
	...
	push {r5, r6, r7}
	sub sp, #0x1c
	ldr r0, _08E8DF0C @ =gUnk_03007FF0
	ldr r0, [r0]
	str r0, [sp, #4]
	ldrb r0, [r0, #0xa]
	cmp r0, #0
