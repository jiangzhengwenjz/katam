...
_08099238: .4byte gLocalPlayerId
...
_0809940C:
	...
	adds r0, r0, r1
	str r0, [r5, #0x34]
	ldr r0, _08099504 @ =gLocalPlayerId
	adds r1, r6, #0
	adds r1, #0x56
	ldrb r0, [r0]
	ldrb r1, [r1]
...
_08099504: .4byte gLocalPlayerId
...
_08099B4A:
	...
	adds r5, r0, #0
	adds r5, #0x56
	ldr r6, _08099B7C @ =gLocalPlayerId
	ldrb r0, [r5]
	ldrb r1, [r6]
	cmp r0, r1
	bne _08099B6E
...
_08099B6E:
	...
	bx r0
	.align 2, 0
_08099B7C: .4byte gLocalPlayerId
