...
_0811BB62:
	...
	ldr r0, _0811BC00 @ =gCurrentPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_0811BC00: .4byte gCurrentPlayerId
...
_0811BC1C:
	...
	ldr r0, _0811BCBC @ =gCurrentPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_0811BCBC: .4byte gCurrentPlayerId
...
sub_0811C07C: @ 0x0811C07C
	...
	ldr r0, _0811C15C @ =gCurrentPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_0811C15C: .4byte gCurrentPlayerId
