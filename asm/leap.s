...
_080B0B46:
	...
	ldr r0, _080B0BA8 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_080B0BA8: .4byte gLocalPlayerId
_080B0BAC: .4byte 0x00000312
_080B0BB0:
	strb r7, [r5]
_080B0BB2:
	ldr r1, _080B0C28 @ =gKirbys
	ldr r0, _080B0C2C @ =gLocalPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_080B0C2C: .4byte gLocalPlayerId
...
_080B0C86:
	...
	ldr r0, _080B0CF0 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_080B0CF0: .4byte gLocalPlayerId
...
_080B0D5A:
	...
	ldr r0, _080B0DA4 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_080B0DA4: .4byte gLocalPlayerId
