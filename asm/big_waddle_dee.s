	...
	thumb_func_start CreateBigWaddleDee
CreateBigWaddleDee: @ 0x080A4A90
	push {r4, r5, r6, lr}
	sub sp, #4
	adds r6, r0, #0
	lsls r1, r1, #0x18
	lsrs r5, r1, #0x18
	ldr r0, _080A4AC4 @ =ObjectMain
	movs r2, #0x80
	lsls r2, r2, #5
	ldr r1, _080A4AC8 @ =ObjectDestroy
	str r1, [sp]
	movs r1, #0xb4
	movs r3, #0x10
	bl TaskCreate
	...
	b _080A4AD4
	.align 2, 0
_080A4AC4: .4byte ObjectMain
_080A4AC8: .4byte ObjectDestroy
_080A4ACC:
	ldrh r1, [r2, #6]
	movs r0, #0xc0
	lsls r0, r0, #0x12
