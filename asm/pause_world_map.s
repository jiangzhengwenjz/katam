...
sub_08125B3C: @ 0x08125B3C
	push {r4, r5, r6, lr}
	sub sp, #8
	ldr r0, _08125B5C @ =gCurGameState
	ldr r2, [r0]
	ldrh r1, [r2, #0x12]
	movs r0, #0x10
	ands r0, r1
...
_08125B68:
	adds r6, r0, #0
	bl sub_08125690
	ldr r0, _08125C50 @ =gCurGameState
	ldr r1, [r0]
...
sub_08125C80: @ 0x08125C80
	push {r4, r5, lr}
	ldr r0, _08125C9C @ =gCurGameState
	ldr r2, [r0]
	ldrh r1, [r2, #0x12]
	movs r0, #0x10
	ands r0, r1
...
_08125CDC:
	...
	bl m4aSongNumStart
	bl sub_08124EC8
	ldr r0, _08125CFC @ =gCurGameState
	ldr r1, [r0]
...
sub_08125D60: @ 0x08125D60
	...
	push {r7}
	sub sp, #8
	ldr r2, _08125D84 @ =gCurGameState
	ldr r3, [r2]
	ldrh r1, [r3, #0x12]
	movs r0, #0x10
	ands r0, r1
...
sub_08125E74: @ 0x08125E74
	push {r4, r5, lr}
	ldr r2, _08125E90 @ =gCurGameState
	ldr r3, [r2]
	ldrh r1, [r3, #0x12]
	movs r0, #0x10
	ands r0, r1
...
sub_08125F1C: @ 0x08125F1C
	push {r4, r5, r6, lr}
	ldr r0, _08125F38 @ =gCurGameState
	ldr r2, [r0]
	ldrh r1, [r2, #0x12]
	movs r0, #0x10
	ands r0, r1
...
_08126052:
	...
	movs r0, #0
	strh r0, [r1]
	ldr r0, _08126078 @ =gCurGameState
	ldr r1, [r0]
...
sub_0812618C: @ 0x0812618C
	push {r4, r5, r6, lr}
	sub sp, #4
	ldr r0, _081261AC @ =gCurGameState
	ldr r2, [r0]
	ldrh r1, [r2, #0x12]
	movs r0, #0x10
	ands r0, r1
...
_0812637C:
	...
	bl sub_0800ACD4
_08126382:
	ldr r0, _08126398 @ =gCurGameState
	ldr r0, [r0]
	bl GameStateDestroy
	movs r0, #0
	bl sub_0801DA58
...
_08126398: .4byte gCurGameState
_0812639C:
	ldr r0, _081263AC @ =gCurGameState
	ldr r0, [r0]
	bl GameStateDestroy
	bl sub_08039670
	b _081263B4
	.align 2, 0
_081263AC: .4byte gCurGameState
_081263B0:
	adds r0, r1, #1
	strh r0, [r4]
_081263B4:
...
sub_081264B8: @ 0x081264B8
	push {r4, lr}
	ldr r0, _081264D4 @ =gCurGameState
	ldr r2, [r0]
	ldrh r1, [r2, #0x12]
	movs r0, #0x10
	ands r0, r1
...
_081264E0:
	...
	cmp r0, #0
	bne _081264F8
	ldr r0, _081264F4 @ =gCurGameState
	ldr r0, [r0]
	bl GameStateDestroy
	b _081264FE
	.align 2, 0
_081264F4: .4byte gCurGameState
_081264F8:
	adds r0, r4, #0
	bl sub_081564D8
_081264FE:
...
sub_08126504: @ 0x08126504
	push {r4, r5, lr}
	ldr r2, _08126520 @ =gCurGameState
	ldr r3, [r2]
	ldrh r1, [r3, #0x12]
	movs r0, #0x10
	ands r0, r1
...
sub_08126558: @ 0x08126558
	push {r4, lr}
	ldr r0, _08126574 @ =gCurGameState
	ldr r2, [r0]
	ldrh r1, [r2, #0x12]
	movs r0, #0x10
	ands r0, r1
...
sub_08126AE0: @ 0x08126AE0
	push {r4, lr}
	ldr r0, _08126AFC @ =gCurGameState
	ldr r2, [r0]
	ldrh r1, [r2, #0x12]
	movs r0, #0x10
	ands r0, r1
...
_08126B08:
	...
	ldr r0, [r0]
	bl GameStateDestroy
	ldr r0, _08126B54 @ =gCurGameState
	ldr r0, [r0]
	bl GameStateDestroy
	bl sub_08039670
_08126B3A:
...
_08126B80:
	...
	ldr r1, _08126C38 @ =gUnk_02020EE0
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r6, r0
	adds r0, r0, r1
...
_08126E9E:
	...
	adds r0, r3, #0
	bl sub_0815604C
	ldr r1, _08126EF4 @ =gUnk_02020EE0
	movs r0, #0xd4
	lsls r0, r0, #1
	mov r2, r8
	muls r2, r0, r2
