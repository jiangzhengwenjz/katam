...
_0812C8A4: .4byte gLanguage
_0812C8A8: .4byte gUnk_08364ACC
_0812C8AC:
	ldr r0, _0812C8D0 @ =gLanguage
	ldrh r1, [r0]
	lsls r0, r1, #1
	adds r0, r0, r1
	lsls r0, r0, #3
