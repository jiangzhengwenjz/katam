...
_0810FED0:
	...
	ldr r4, _0810FF64 @ =gDarkMindForm2Enemy3Types
	mov ip, r4
...
_0810FF64: .4byte gDarkMindForm2Enemy3Types
...
_08110054:
	...
	adds r4, r4, r5
	mov r8, r4
	ldr r3, _081100EC @ =gDarkMindForm2Enemy2Types
	mov ip, r3
	cmp r2, r0
	blt _08110090
	adds r3, r0, #0
...
_081100EC: .4byte gDarkMindForm2Enemy2Types
_081100F0:
	adds r0, r3, #1
	lsls r0, r0, #0x18
	lsrs r3, r0, #0x18
...
_081101D8:
	...
	adds r4, r4, r5
	mov r8, r4
	ldr r4, _08110294 @ =gDarkMindForm2Enemy1Types
	mov ip, r4
	cmp r3, r0
	blt _08110214
	adds r4, r0, #0
...
_08110294: .4byte gDarkMindForm2Enemy1Types
_08110298:
	adds r0, r3, #1
	lsls r0, r0, #0x18
	lsrs r3, r0, #0x18
