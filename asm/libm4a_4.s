...
sub_08D79510: @ 0x08D79510
	...
	movs r0, #0x77
	strb r0, [r3]
	ldr r0, _08D795E4 @ =SOUND_INFO_PTR
	ldr r4, [r0]
	ldr r6, [r4]
...
_08D795E4: .4byte SOUND_INFO_PTR
...
_08D7967E:
	...
	str r0, [r1]
	ldr r0, _08D79734 @ =SOUND_INFO_PTR
	str r5, [r0]
	str r3, [sp]
...
_08D79734: .4byte SOUND_INFO_PTR
...
sub_08D7974C: @ 0x08D7974C
	push {r4, r5, r6, lr}
	adds r2, r0, #0
	ldr r0, _08D797CC @ =SOUND_INFO_PTR
	ldr r4, [r0]
	movs r0, #0xf0
	lsls r0, r0, #0xc
	ands r0, r2
...
_08D797B8:
	...
	bx r0
	.align 2, 0
_08D797CC: .4byte SOUND_INFO_PTR
...
sub_08D797F0: @ 0x08D797F0
	push {r4, r5, lr}
	adds r3, r0, #0
	ldr r0, _08D7987C @ =SOUND_INFO_PTR
	ldr r5, [r0]
	ldr r1, [r5]
...
_08D79876:
	...
	bx r0
	.align 2, 0
_08D7987C: .4byte SOUND_INFO_PTR
...
sub_08D79888: @ 0x08D79888
	push {r4, r5, r6, r7, lr}
	ldr r0, _08D798D4 @ =SOUND_INFO_PTR
	ldr r6, [r0]
	ldr r1, [r6]
...
_08D798CE:
	...
	bx r0
	.align 2, 0
_08D798D4: .4byte SOUND_INFO_PTR
...
sub_08D798DC: @ 0x08D798DC
	push {lr}
	sub sp, #4
	ldr r0, _08D7993C @ =SOUND_INFO_PTR
	ldr r2, [r0]
	ldr r1, [r2]
...
_08D79934:
	...
	bx r0
	.align 2, 0
_08D7993C: .4byte SOUND_INFO_PTR
...
sub_08D79958: @ 0x08D79958
	push {r4, lr}
	ldr r0, _08D79988 @ =SOUND_INFO_PTR
	ldr r2, [r0]
	ldr r3, [r2]
...
_08D79980:
	...
	bx r0
	.align 2, 0
_08D79988: .4byte SOUND_INFO_PTR
...
sub_08D79994: @ 0x08D79994
	...
	movs r4, #0x10
_08D799A8:
	ldr r0, _08D79A00 @ =SOUND_INFO_PTR
	ldr r5, [r0]
	ldr r1, [r5]
...
_08D799F8:
	...
	bx r0
	.align 2, 0
_08D79A00: .4byte SOUND_INFO_PTR
...
sub_08D79E0C: @ 0x08D79E0C
	...
	push {r5, r6, r7}
	sub sp, #0x1c
	ldr r0, _08D79E2C @ =SOUND_INFO_PTR
	ldr r0, [r0]
	str r0, [sp, #4]
	ldrb r0, [r0, #0xa]
	cmp r0, #0
	...
	b _08D79E36
	.align 2, 0
_08D79E2C: .4byte SOUND_INFO_PTR
_08D79E30:
	movs r0, #0xe
	ldr r2, [sp, #4]
	strb r0, [r2, #0xa]
