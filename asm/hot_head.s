...
_080C37B8:
	...
	ldr r0, _080C3864 @ =gLocalPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_080C3864: .4byte gLocalPlayerId
...
_080C38CE:
	...
	ldr r0, _080C3940 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_080C3940: .4byte gLocalPlayerId
...
_080C3C1A:
	...
	ldr r0, _080C3CD4 @ =gLocalPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_080C3CD4: .4byte gLocalPlayerId
...
_080C3D1C:
	...
	ldr r0, _080C3D8C @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_080C3D8C: .4byte gLocalPlayerId
