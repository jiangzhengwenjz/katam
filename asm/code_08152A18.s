...
_08156EF4:
	...
	subs r3, r0, #1
	lsls r0, r3, #3
	ldr r2, _08156F6C @ =gOamBuffer
	adds r5, r0, r2
	cmp r3, #0
	blt _08156F2E
	ldr r2, _08156F70 @ =0x040000D4
	ldr r6, _08156F74 @ =0x80000003
	ldr r0, _08156F6C @ =gOamBuffer
	movs r1, #0xfe
	lsls r1, r1, #2
	adds r4, r0, r1
	adds r1, r5, #0
