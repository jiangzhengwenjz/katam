...
_080B9E9E:
	...
	ldr r0, _080B9F20 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_080B9F20: .4byte gLocalPlayerId
...
_080B9F2E:
	...
	ldr r0, _080B9F64 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_080B9F64: .4byte gLocalPlayerId
_080B9F68:
	mov r0, sl
_080B9F6A:
	strb r0, [r4]
_080B9F6C:
	...
	ldr r0, _080B9FE8 @ =gLocalPlayerId
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
...
_080B9FE8: .4byte gLocalPlayerId
...
_080BA048:
	...
	ldr r0, _080BA0B4 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_080BA0B4: .4byte gLocalPlayerId
...
_080BA11E:
	...
	ldr r0, _080BA160 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_080BA160: .4byte gLocalPlayerId
...
_080BA172:
	...
	ldr r0, _080BA1BC @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_080BA1BC: .4byte gLocalPlayerId
