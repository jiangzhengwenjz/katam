...
_08118C6C:
	...
	ldr r0, _08118D24 @ =gLocalPlayerId
	ldrb r1, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r1, r0
...
_08118D24: .4byte gLocalPlayerId
_08118D28:
	adds r0, r3, #0
	adds r0, #0x2b
	mov r2, sb
...
sub_08118D80: @ 0x08118D80
	...
	lsls r2, r2, #3
	adds r1, r1, r2
	ldr r0, _08118E44 @ =gLocalPlayerId
	ldrb r5, [r0]
	adds r0, r5, #0
	muls r0, r3, r0
	adds r0, r0, r4
...
_08118E44: .4byte gLocalPlayerId
...
_08118EC0:
	...
	movs r0, #0
	mov r8, r0
	ldr r0, _0811907C @ =gNumHumanPlayers
	ldrb r1, [r0]
	mov ip, sb
	cmp r8, r1
	bhs _08118F9C
...
_08118FA2:
	movs r0, #0
	ldr r2, _0811907C @ =gNumHumanPlayers
	ldrb r1, [r2]
	cmp r0, r1
	bhs _08118FB6
_08118FAC:
...
_0811907C: .4byte gNumHumanPlayers
