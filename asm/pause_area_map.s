...
sub_08127FCC: @ 0x08127FCC
	push {r4, lr}
	ldr r0, _08127FE8 @ =gCurGameState
	ldr r2, [r0]
	ldrh r1, [r2, #0x12]
	movs r0, #0x10
	ands r0, r1
...
_08128026:
	...
	bl m4aSongNumStart
	bl sub_08124EC8
	ldr r0, _08128040 @ =gCurGameState
	ldr r1, [r0]
...
_08128048:
	...
	movs r1, #0x7f
	bl sub_0803D280
	ldr r0, _0812806C @ =gCurGameState
	ldr r1, [r0]
...
sub_0812824C: @ 0x0812824C
	...
	mov r6, r8
	push {r6, r7}
	ldr r0, _08128270 @ =gCurGameState
	ldr r2, [r0]
	ldrh r1, [r2, #0x12]
	movs r0, #0x10
	ands r0, r1
...
_081282B6:
	...
	bl m4aSongNumStart
	bl sub_08124EC8
	ldr r0, _081282D0 @ =gCurGameState
	ldr r1, [r0]
...
sub_08128788: @ 0x08128788
	push {r4, lr}
	ldr r0, _081287A4 @ =gCurGameState
	ldr r2, [r0]
	ldrh r1, [r2, #0x12]
	movs r0, #0x10
	ands r0, r1
...
_081287E2:
	...
	bx r0
	.align 2, 0
_081287F0: .4byte gCurGameState

	thumb_func_start sub_081287F4
sub_081287F4: @ 0x081287F4
	push {r4, lr}
	ldr r0, _08128810 @ =gCurGameState
	ldr r2, [r0]
	ldrh r1, [r2, #0x12]
	movs r0, #0x10
	ands r0, r1
...
_0812881C:
	...
	ldr r0, [r0]
	bl GameStateDestroy
	ldr r0, _08128864 @ =gCurGameState
	ldr r0, [r0]
	bl GameStateDestroy
	bl sub_08039670
_08128854:
...
sub_08128980: @ 0x08128980
	push {r4, r5, lr}
	ldr r0, _0812899C @ =gCurGameState
	ldr r2, [r0]
	ldrh r1, [r2, #0x12]
	movs r0, #0x10
	ands r0, r1
...
_081289DC:
	...
	b _08128A20
_081289FC:
	ldr r0, _08128A08 @ =gCurGameState
	ldr r0, [r0]
	bl GameStateDestroy
	b _08128A20
	.align 2, 0
_08128A08: .4byte gCurGameState
_08128A0C:
	ldrh r1, [r4, #0x38]
	movs r0, #0x80
	lsls r0, r0, #2
	...
	cmp r0, #0
	beq _08128A20
	ldr r0, _08128A28 @ =gCurGameState
	ldr r0, [r0]
	bl GameStateDestroy
_08128A20:
	pop {r4, r5}
