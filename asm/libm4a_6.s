...
sub_08D9C100: @ 0x08D9C100
	...
	movs r0, #0x77
	strb r0, [r3]
	ldr r0, _08D9C1D4 @ =SOUND_INFO_PTR
	ldr r4, [r0]
	ldr r6, [r4]
...
_08D9C1D4: .4byte SOUND_INFO_PTR
...
_08D9C26E:
	...
	str r0, [r1]
	ldr r0, _08D9C324 @ =SOUND_INFO_PTR
	str r5, [r0]
	str r3, [sp]
...
_08D9C324: .4byte SOUND_INFO_PTR
...
sub_08D9C33C: @ 0x08D9C33C
	push {r4, r5, r6, lr}
	adds r2, r0, #0
	ldr r0, _08D9C3BC @ =SOUND_INFO_PTR
	ldr r4, [r0]
	movs r0, #0xf0
	lsls r0, r0, #0xc
	ands r0, r2
...
_08D9C3A8:
	...
	bx r0
	.align 2, 0
_08D9C3BC: .4byte SOUND_INFO_PTR
...
sub_08D9C3E0: @ 0x08D9C3E0
	push {r4, r5, lr}
	adds r3, r0, #0
	ldr r0, _08D9C46C @ =SOUND_INFO_PTR
	ldr r5, [r0]
	ldr r1, [r5]
...
_08D9C466:
	...
	bx r0
	.align 2, 0
_08D9C46C: .4byte SOUND_INFO_PTR
...
sub_08D9C478: @ 0x08D9C478
	push {r4, r5, r6, r7, lr}
	ldr r0, _08D9C4C4 @ =SOUND_INFO_PTR
	ldr r6, [r0]
	ldr r1, [r6]
...
_08D9C4BE:
	...
	bx r0
	.align 2, 0
_08D9C4C4: .4byte SOUND_INFO_PTR
...
sub_08D9C4CC: @ 0x08D9C4CC
	push {lr}
	sub sp, #4
	ldr r0, _08D9C52C @ =SOUND_INFO_PTR
	ldr r2, [r0]
	ldr r1, [r2]
...
_08D9C524:
	...
	bx r0
	.align 2, 0
_08D9C52C: .4byte SOUND_INFO_PTR
...
sub_08D9C548: @ 0x08D9C548
	push {r4, lr}
	ldr r0, _08D9C578 @ =SOUND_INFO_PTR
	ldr r2, [r0]
	ldr r3, [r2]
...
_08D9C570:
	...
	bx r0
	.align 2, 0
_08D9C578: .4byte SOUND_INFO_PTR
...
sub_08D9C584: @ 0x08D9C584
	...
	movs r4, #0x10
_08D9C598:
	ldr r0, _08D9C5F0 @ =SOUND_INFO_PTR
	ldr r5, [r0]
	ldr r1, [r5]
...
_08D9C5E8:
	...
	bx r0
	.align 2, 0
_08D9C5F0: .4byte SOUND_INFO_PTR
...
sub_08D9C9FC: @ 0x08D9C9FC
	...
	push {r5, r6, r7}
	sub sp, #0x1c
	ldr r0, _08D9CA1C @ =SOUND_INFO_PTR
	ldr r0, [r0]
	str r0, [sp, #4]
	ldrb r0, [r0, #0xa]
	cmp r0, #0
	...
	b _08D9CA26
	.align 2, 0
_08D9CA1C: .4byte SOUND_INFO_PTR
_08D9CA20:
	movs r0, #0xe
	ldr r2, [sp, #4]
	strb r0, [r2, #0xa]
