	...
	thumb_func_start sub_081230A4
sub_081230A4: @ 0x081230A4
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
...
_081230DE:
	...
	b _0812317A
	.align 2, 0
_08123104: .4byte 0x00000101
_08123108:
	movs r1, #1
	mov r8, r1
	adds r0, r5, #1
	strb r0, [r2]
	ldr r1, _081231C8 @ =gUnk_02020EE0
	ldr r0, _081231CC @ =gUnk_0203AD3C
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
	...
	bne _0812317A
_0812313C:
	ldr r1, _081231D0 @ =gUnk_08D60FA4
	ldr r5, _081231D4 @ =gSongTable
	ldr r2, _081231D8 @ =0x00000FB4
	adds r0, r5, r2
	ldrh r3, [r0]
	lsls r0, r3, #2
	adds r0, r0, r1
...
_08123162:
	cmp r3, #0
	beq _08123172
	ldr r0, _081231DC @ =gUnk_0203AD10
	ldr r0, [r0]
	mov r2, ip
	ands r0, r2
	cmp r0, #0
...
_08123188:
	...
	movs r0, #0xff
	strb r0, [r1]
	ldr r3, _081231E0 @ =gUnk_08351648
	mov r0, sb
	ldrb r1, [r0]
	lsls r0, r1, #1
	adds r0, r0, r1
	...
	b _0812326E
	.align 2, 0
_081231C8: .4byte gUnk_02020EE0
_081231CC: .4byte gUnk_0203AD3C
_081231D0: .4byte gUnk_08D60FA4
_081231D4: .4byte gSongTable
_081231D8: .4byte 0x00000FB4
_081231DC: .4byte gUnk_0203AD10
_081231E0: .4byte gUnk_08351648
_081231E4:
	adds r1, r4, #0
	adds r1, #0xdc
	ldrb r0, [r1]
	...
	adds r0, #1
	strb r0, [r1]
	ldr r1, _08123290 @ =gUnk_02020EE0
	ldr r0, _08123294 @ =gUnk_0203AD3C
	ldrb r2, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r2, r0
	...
	bne _0812325E
_0812321E:
	ldr r1, _08123298 @ =gUnk_08D60FA4
	ldr r4, _0812329C @ =gSongTable
	ldr r2, _081232A0 @ =0x00000FB4
	adds r0, r4, r2
	ldrh r3, [r0]
	lsls r0, r3, #2
	adds r0, r0, r1
...
_08123244:
	cmp r3, #0
	beq _08123256
	ldr r0, _081232A4 @ =gUnk_0203AD10
	ldr r0, [r0]
	movs r1, #0x80
	lsls r1, r1, #1
	ands r0, r1
...
_0812326E:
	bl sub_080335B4
	ldr r2, _081232A8 @ =gUnk_0203AD20
	ldr r0, [r2]
	movs r1, #2
	rsbs r1, r1, #0
	ands r0, r1
...
_0812327E:
	...
	bx r0
	.align 2, 0
_08123290: .4byte gUnk_02020EE0
_08123294: .4byte gUnk_0203AD3C
_08123298: .4byte gUnk_08D60FA4
_0812329C: .4byte gSongTable
_081232A0: .4byte 0x00000FB4
_081232A4: .4byte gUnk_0203AD10
_081232A8: .4byte gUnk_0203AD20

	thumb_func_start sub_081232AC
sub_081232AC: @ 0x081232AC
	push {r4, lr}
	adds r2, r0, #0
	lsls r1, r1, #0x18
	lsrs r1, r1, #0x18
...
_081232C4:
	...
	adds r0, #0x60
	ldrh r3, [r0]
	ldr r0, _08123320 @ =0x00000383
	cmp r3, r0
	bhi _08123308
	subs r0, #0x62
	cmp r3, r0
	beq _08123308
	ldr r0, _08123324 @ =gUnk_0835105C
	ldrh r4, [r0, #2]
	cmp r3, r4
	beq _08123308
	ldrh r4, [r0, #4]
...
_08123314:
	lsls r0, r1, #2
	ldr r1, _08123328 @ =_0812332C
	adds r0, r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_08123320: .4byte 0x00000383
_08123324: .4byte gUnk_0835105C
_08123328: .4byte _0812332C
_0812332C: @ jump table
	.4byte _08123344 @ case 0
	.4byte _08123368 @ case 1
	.4byte _0812338C @ case 2
	.4byte _081233B0 @ case 3
	.4byte _081233DC @ case 4
	.4byte _081233F8 @ case 5
_08123344:
	adds r0, r2, #0
	adds r0, #0xe1
	movs r1, #0
	...
	movs r0, #0xff
	strb r0, [r1]
	ldr r0, _08123360 @ =gUnk_08351648
	ldr r1, _08123364 @ =0x000008D4
	adds r0, r0, r1
	b _081233CA
	.align 2, 0
_08123360: .4byte gUnk_08351648
_08123364: .4byte 0x000008D4
_08123368:
	adds r0, r2, #0
	adds r0, #0xe1
	movs r1, #0
	...
	movs r0, #0xff
	strb r0, [r1]
	ldr r0, _08123384 @ =gUnk_08351648
	ldr r4, _08123388 @ =0x000008EC
	b _081233C8
	.align 2, 0
_08123384: .4byte gUnk_08351648
_08123388: .4byte 0x000008EC
_0812338C:
	adds r0, r2, #0
	adds r0, #0xe1
	movs r1, #0
	...
	movs r0, #0xff
	strb r0, [r1]
	ldr r0, _081233A8 @ =gUnk_08351648
	ldr r1, _081233AC @ =0x00000904
	adds r0, r0, r1
	b _081233CA
	.align 2, 0
_081233A8: .4byte gUnk_08351648
_081233AC: .4byte 0x00000904
_081233B0:
	adds r0, r2, #0
	adds r0, #0xe1
	movs r1, #0
	...
	movs r0, #0xff
	strb r0, [r1]
	ldr r0, _081233D4 @ =gUnk_08351648
	ldr r4, _081233D8 @ =0x0000091C
_081233C8:
	adds r0, r0, r4
_081233CA:
	ldrh r1, [r0]
	...
	b _08123412
	.align 2, 0
_081233D4: .4byte gUnk_08351648
_081233D8: .4byte 0x0000091C
_081233DC:
	adds r1, r2, #0
	adds r1, #0xe1
	movs r0, #0
...
_08123412:
	...
	thumb_func_start sub_08123418
sub_08123418: @ 0x08123418
	push {r4, r5, lr}
	adds r4, r0, #0
	ldr r2, [r4, #0x6c]
	movs r0, #0x81
...
_08123430:
	adds r0, #1
	strb r0, [r1]
	ldr r1, _081234B4 @ =gUnk_02020EE0
	ldr r0, _081234B8 @ =gUnk_0203AD3C
	ldrb r3, [r0]
	movs r0, #0xd4
	lsls r0, r0, #1
	muls r0, r3, r0
	...
	bne _0812349C
_08123460:
	ldr r1, _081234BC @ =gUnk_08D60FA4
	ldr r5, _081234C0 @ =gSongTable
	ldr r2, _081234C4 @ =0x00000FAC
	adds r0, r5, r2
	ldrh r3, [r0]
	lsls r0, r3, #2
	adds r0, r0, r1
...
_08123484:
	cmp r3, #0
	beq _08123496
	ldr r0, _081234CC @ =gUnk_0203AD10
	ldr r0, [r0]
	movs r1, #0x80
	lsls r1, r1, #1
	ands r0, r1
...
_0812349C:
	...
	bx r0
	.align 2, 0
_081234B4: .4byte gUnk_02020EE0
_081234B8: .4byte gUnk_0203AD3C
_081234BC: .4byte gUnk_08D60FA4
_081234C0: .4byte gSongTable
_081234C4: .4byte 0x00000FAC
_081234C8: .4byte 0x00000FA8
_081234CC: .4byte gUnk_0203AD10
_081234D0: .4byte 0x000001F5
