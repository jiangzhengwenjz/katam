...
_0815720C: .4byte 0x0000FFFF
	...
	thumb_func_start sub_08157210
sub_08157210: @ 0x08157210
	push {r4, r5, r6, r7, lr}
	sub sp, #4
	adds r5, r0, #0
	...
	movs r0, #0
	str r0, [sp]
	ldr r4, _081572E8 @ =gUnk_03006A60
...
_081572E8: .4byte gUnk_03006A60
_081572EC: .4byte 0x0500007A
_081572F0: .4byte sub_08158F14
_081572F4: .4byte gUnk_03006C50
_081572F8: .4byte 0x04000010
_081572FC: .4byte sub_08158F54
_08157300: .4byte gUnk_030068E0
_08157304: .4byte 0x04000060

	thumb_func_start sub_08157308
sub_08157308: @ 0x08157308
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
	...
	ldr r6, [r5]
	ldr r0, _08157334 @ =gUnk_03006A60
	ldrb r2, [r0, #1]
	adds r7, r0, #0
	cmp r2, #1
	beq _081573A8
...
_081573A4:
	...
	strb r0, [r7, #1]
_081573A8:
	ldr r2, _081573DC @ =gUnk_03006A60
	ldrb r0, [r2, #2]
	cmp r0, #0
	beq _081573E4
	ldrb r1, [r2, #8]
...
_081573E4:
	...
	bl sub_08157464
_081573F2:
	ldr r1, _08157424 @ =gUnk_03006A60
	ldrb r0, [r1, #0xb]
	adds r0, #1
	strb r0, [r1, #0xb]
	ldrb r3, [r1, #3]
...
_08157456:
	...
	thumb_func_start sub_08157464
sub_08157464: @ 0x08157464
	push {r4, r5, r6, r7, lr}
	movs r7, #0
	ldr r5, _08157524 @ =gUnk_03006A60
	ldr r4, [r5, #0x28]
	movs r2, #1
	ands r1, r2
	lsls r1, r1, #4
	...
	strb r2, [r4, #1]
	ldr r6, [r5, #0x28]
	ldr r1, _08157528 @ =gUnk_03006C90
	ldrb r1, [r1, #3]
	movs r3, #1
	adds r2, r3, #0
	ands r2, r1
...
_0815751E:
	...
	bx r0
	.align 2, 0
_08157524: .4byte gUnk_03006A60
_08157528: .4byte gUnk_03006C90
_0815752C: .4byte 0x04000005
_08157530: .4byte 0x0400010E

	thumb_func_start sub_08157534
sub_08157534: @ 0x08157534
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_081575E0:
	...
	cmp r4, #3
	ble _0815756E
	ldr r0, _08157650 @ =gUnk_03006A60
	ldrb r1, [r0, #2]
	ldrb r2, [r0, #3]
	adds r3, r1, #0
	orrs r3, r2
...
_08157630:
	...
	b _08157674
	.align 2, 0
_0815764C: .4byte gUnk_03006C50
_08157650: .4byte gUnk_03006A60
...
_0815768C:
	...
	thumb_func_start sub_081576A0
sub_081576A0: @ 0x081576A0
	push {lr}
	ldr r2, _081576B8 @ =gUnk_03006A60
	ldrb r0, [r2]
	cmp r0, #0
	beq _081576B2
	ldrb r0, [r2, #8]
...
_081576B2:
	...
	bx r0
	.align 2, 0
_081576B8: .4byte gUnk_03006A60

	thumb_func_start sub_081576BC
sub_081576BC: @ 0x081576BC
	...
	movs r0, #0xc0
	strh r0, [r1]
	ldr r2, _08157708 @ =gUnk_03006A60
	ldrb r1, [r2, #8]
	movs r0, #0x7f
	ands r0, r1
	strb r0, [r2, #8]
