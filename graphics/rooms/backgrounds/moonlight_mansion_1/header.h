...
static const u16 gMoonlightMansion1Palette[] = {
...
static const u32 gMoonlightMansion1Tileset[] = INCBIN_U32("graphics/rooms/backgrounds/moonlight_mansion_1/tileset.4bpp.lz");
static const u16 gMoonlightMansion1Tilemap[] = INCBIN_U16("graphics/rooms/backgrounds/moonlight_mansion_1/tilemap.bin");

const struct RoomBackgroundTiles gMoonlightMansion1RoomBackgroundTiles = {
    .width = 45,
    .height = 20,
    .unk4 = 0,
    .unk6 = 0,
    .unk7 = 0,
    .tileset = gMoonlightMansion1Tileset,
    .tilesetSize = 0x384,
    .palette = gMoonlightMansion1Palette,
    .paletteOffset = 0x60,
    .paletteSize = ARRAY_COUNT(gMoonlightMansion1Palette),
    .tilemap = gMoonlightMansion1Tilemap,
    .unk1C = 0x640000
};
