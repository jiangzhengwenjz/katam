...
struct ThrowAbilityObject *sub_0807A7E8(struct ObjectHeader *);
...
void sub_0807DBCC(struct Object *);
...
void sub_0808520C(struct Object *, s16);
void sub_08085328(struct Kirby *);
void sub_080857A0(struct Object *);
...
struct Object6 *sub_0808671C(struct Object *);
void sub_080867A0(struct Object6 *);
struct Object6 *sub_08086938(struct Object *, u8);
void sub_08086A28(struct Object6 *, u8);
void sub_08086C48(struct Object*);
...
struct Object7 *sub_08088398(struct Object *, const struct AnimInfo *);
void sub_0808840C(struct Kirby *);
void sub_0808845C(struct Object *, u16);
...
struct EffectObject *CreateEffectObject(struct ObjectBase *, u32, u16, u8);
struct EffectObject *sub_0808B62C(struct ObjectBase *, u32, u16, u8, u16);
struct EffectObject *sub_0808BA6C(struct ObjectBase *, u32, u16, u8);
struct EffectObject *sub_0808BEA4(struct Kirby *, u32, u16, u8, u32);
void sub_0808CBCC(struct Kirby *);
void sub_0808CFC0(struct Kirby *);
void sub_0808D5E0(struct Kirby *);
...
void sub_0808E9C8(struct Kirby *);
struct EffectObject *sub_0808EDB8(struct Kirby *);
struct EffectObject *sub_0808F0E8(struct Kirby *);
...
struct EffectObject *sub_08092944(struct ObjectBase *, u32, u16, u8);
...
void sub_08097B9C(struct Object *arg0, struct Kirby *kirby);
