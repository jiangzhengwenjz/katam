...
void *DarkMindLaserShot(struct Object *, u8);
void *DarkMindLaserBeam(struct Object *, u8);
...
extern const struct AnimInfo gDarkMindAnimInfo4[];
extern const struct AnimInfo gDarkMindAnimInfo5[];
extern const struct AnimInfo gDarkMindAnimInfo6[];
extern const struct AnimInfo gDarkMindAnimInfo7[];
extern const struct AnimInfo gUnk_08357300;
extern const struct AnimInfo gDarkMindAnimInfo8[];
extern const struct AnimInfo gDarkMindAnimInfo9[];
extern const struct AnimInfo gDarkMindAnimInfo10[];
extern const struct AnimInfo gDarkMindAnimInfo11[];
extern const struct MoveStep gDarkMindMoveSteps3[];
extern const struct MoveStep gDarkMindMoveSteps4[];
extern const struct MoveStep gDarkMindMoveSteps5[];
extern const struct MoveStep gDarkMindMoveSteps6[];
extern const struct AnimInfo gDarkMindAnimInfo12[];
