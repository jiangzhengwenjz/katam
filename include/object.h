...
#define Macro_08100F18(obj2) ({ \
 ...
 \
        ...
        if (gKirbys[gCurrentPlayerId].base.base.base.roomId == (obj2)->base.roomId && !(gUnk_0203AD20 & 4)) \
...
#define Macro_080FC150(objBase /* obj4 */, sprite) ({ \
 ...
 \
    ...
    (sprite)->x = ((objBase)->x >> 8) - (gCurLevelInfo[gCurrentPlayerId].viewportPosition.x >> 8) + (objBase)->objBase54; \
    (sprite)->y = ((objBase)->y >> 8) - (gCurLevelInfo[gCurrentPlayerId].viewportPosition.y >> 8) + (objBase)->objBase55; \
    if ((sprite)->unk1C) \
    { \
        (objBase)->objBase54 = 0; \
        (objBase)->objBase55 = 0; \
