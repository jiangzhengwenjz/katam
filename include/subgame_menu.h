...
void sub_0801FEC0(struct SubGameMenu*);
void sub_0801FEFC(struct SubGameMenu*);
void sub_0801FF0C(struct SubGameMenu*);
void sub_0801FF28(struct SubGameMenu*);
void sub_0801FF50(struct SubGameMenu*);
void sub_0801FFB0(struct SubGameMenu*);
void sub_0801FFEC(struct SubGameMenu*);
void sub_0802001C(struct SubGameMenu*);
void sub_08020058(struct SubGameMenu*);
void sub_08020094(struct SubGameMenu*);
void sub_080200C0(struct SubGameMenu*);
void sub_08020118(struct SubGameMenu*);
void sub_08020164(struct SubGameMenu*);
void sub_080201A0(struct SubGameMenu*);
void sub_080201D0(struct SubGameMenu*);
void sub_080201EC(struct SubGameMenu*);
void nullsub_29(struct Task*);
void nullsub_110(struct Task*);
void nullsub_111(struct Task*);
