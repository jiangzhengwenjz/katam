...
const struct AnimInfo gBlockinAnimInfo[] = {
    { 0x30F, 0, 0 },
    { 0x30F, 1, 0 },
    { 0x30F, 2, 0 },
    { 0x30F, 3, 0 },
...
void* CreateBlockin(struct Object* arg0, u8 arg1) {
    ...
    ObjectSetHitbox(&obj->base, -5, -5, 5, 4);
...
static void sub_080A4728(struct Object2* arg0) {
    ...
    if (arg0->unk90 != 0) {
        arg0->base.unk6C = FindClosestKirby(&arg0->base);
        sub_080A4A08(arg0);
    }
    else {
        Macro_080A4728(arg0);
...
static void sub_080A47C8(struct Object2* arg0) {
    if (arg0->base.flags & 2) {
        ...
        if (arg0->base.counter <= 0x13) {
            ...
            arg0->base.objBase54 = gScreenShakePatterns[(arg0->base.counter - 0x14)][0];
            arg0->base.objBase55 = gScreenShakePatterns[(arg0->base.counter - 0x14)][1];
        }
        arg0->base.counter++;
    }
}
