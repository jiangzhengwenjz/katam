...
void sub_08106AD0(struct DarkMindForm1 *r5)
{
    struct DarkMindForm1 *r6;
    struct Task *t;
    ...
    if (!(r5->unk0.base.flags & 0x1000))
    {
        ...
        if (!(r5->unk0.base.flags & 1)) r4->flags |= 1;
...
{
    r2->unk0.unk78 = (void *)sub_08114578;
    r2->unk0.unk83 = 8;
    r2->unk0.base.xspeed = 0;
    r2->unk0.base.yspeed = 0;
...
void sub_08112880(void)
{
    ...
    struct DarkMindForm2 *r7 = (void *)r5->unk44;
...
{
    const u16 *src = gUnk_08D64A24[gRoomProps[0x396].backgroundIdx]->unk1C;
...
{
    r3->unk0.unk78 = (void *)sub_0810D1D0;
    r3->unk0.base.xspeed = 0;
    r3->unk0.base.yspeed = 0;
    r3->unk0.base.flags &= ~1;
