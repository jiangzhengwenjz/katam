...
const struct Unk_02021590 gUnk_0835409C[] = {
    { 0x307,   0, 0 },
    { 0x307,   1, 0 },
    { 0x307,   2, 0 },
    { 0x307,   8, 0 },
...
{
    if (boxin->base.x <= gCurLevelInfo[boxin->base.unk56].unk50
        && boxin->base.x >= gCurLevelInfo[boxin->base.unk56].unk48
        && boxin->base.y <= gCurLevelInfo[boxin->base.unk56].unk54
        && boxin->base.y >= gCurLevelInfo[boxin->base.unk56].unk4C)
    {
