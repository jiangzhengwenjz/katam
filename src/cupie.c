...
{
    {0xffa0, 0xff60, 0x0000, 0x0000, 0x14, 0x00, 0x00, 0x00},
    {0xff60, 0xff80, 0x0000, 0x0000, 0x14, 0x00, 0x00, 0x00},
    {0xff10, 0xffd0, 0x0000, 0x0000, 0x14, 0x00, 0x00, 0x00},
    {0xff10, 0x0030, 0x0000, 0x0000, 0x14, 0x00, 0x00, 0x00},
    {0xff60, 0x0080, 0x0000, 0x0000, 0x14, 0x00, 0x00, 0x00},
    {0xffa0, 0x00a0, 0x0000, 0x0000, 0x14, 0x00, 0x00, 0x00},
    {0x0060, 0x00a0, 0x0000, 0x0000, 0x14, 0x00, 0x00, 0x00},
    {0x00a0, 0x0080, 0x0000, 0x0000, 0x14, 0x00, 0x00, 0x00},
    {0x00f0, 0x0030, 0x0000, 0x0000, 0x14, 0x00, 0x00, 0x00},
    {0x00f0, 0xffd0, 0x0000, 0x0000, 0x14, 0x00, 0x00, 0x00},
    {0x00a0, 0xff80, 0x0000, 0x0000, 0x14, 0x00, 0x00, 0x00},
    {0x0060, 0xff60, 0x0000, 0x0000, 0x14, 0x00, 0x00, 0x00},
    {0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00},
};

static const struct Unk_08353510 gUnk_08353070[] = 
{
    {0x0140, 0xffe0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x00f0, 0xffc8, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0060, 0xffa0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xffa0, 0xffa0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xff10, 0xffc8, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xfec0, 0xffe0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xfec0, 0x0020, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xff10, 0x0038, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xffa0, 0x0060, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0060, 0x0060, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x00f0, 0x0038, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0140, 0x0020, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0140, 0x0020, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x00f0, 0x0038, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0060, 0x0060, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xffa0, 0x0060, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    ...
    {0x0140, 0xffe0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0000, 0x0000, 0x0000, 0x0000, 0x00, 0x00, 0x00, 0x00},
    {0x0240, 0xfff0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x01a0, 0xffd8, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x00a0, 0xffc0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xff60, 0xffc0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xfe60, 0xffd8, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xfdc0, 0xfff0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xfdc0, 0x0010, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xfe60, 0x0028, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xff60, 0x0040, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x00a0, 0x0040, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x01a0, 0x0028, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0240, 0x0010, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0240, 0x0010, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x01a0, 0x0028, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x00a0, 0x0040, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xff60, 0x0040, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
...
{
    {0xffe0, 0x00e0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xffc8, 0x00c0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xffa0, 0x0060, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xffa0, 0xffa0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xffc8, 0xff40, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0xffe0, 0xff20, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0020, 0xff20, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0038, 0xff40, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0060, 0xffa0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0060, 0x0060, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0038, 0x00c0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0020, 0x00e0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0020, 0x00e0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0038, 0x00c0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0060, 0x0060, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
    {0x0060, 0xffa0, 0x0000, 0x0000, 0x10, 0x00, 0x00, 0x00},
...
void sub_080A35C8(struct Object2* arg0) {
    ...
    obj->unk16 = 0;
    obj->unk18 = 0;
    obj2_2 = CreateObject(arg0->base.unk56, obj);
    obj2_2->base.parent = arg0;
    obj2 = obj2_2;
    if (arg0->base.flags & 1) {
        obj2->base.flags |= 1;
    }
    if (RandLessThan3()) {
        obj2->base.xspeed = (Rand16() % 256) + 0x1c0;
    }
    else {
        u16 r1;
        obj2->base.xspeed = (Rand16() % 256) + (r1 = 0x300);
    }
    obj2->base.yspeed = 0;
    if (arg0->base.flags & 1) {
