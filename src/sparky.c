...
const struct AnimInfo gSparkyAnimInfo[] = {
    { 0x32E, 0x0, 0x0 },
    { 0x32E, 0x1, 0x0 },
    { 0x32E, 0x2, 0x0 },
    { 0x32E, 0x3, 0x0 },
...
static void sub_080C4338(struct Object2* arg0) {
    ...
    if (arg0->object->subtype1 != 0) {
        ...
        if (++arg0->base.counter > 8) {
            ...
            ObjectSetHitbox(&arg0->base, unk0, unk0, 5, 6);
...
static void SparkyShockAttack(struct Object2* arg0) {
    arg0->base.flags |= 4;
    if (!(arg0->base.unk1 & 3) || (arg0->base.unk1 & 3) == 3) {
        ObjectSetHitbox(&arg0->base, -17, -12, 17, 20);
    }
    else {
        ObjectSetHitbox(&arg0->base, -5, -5, 5, 6);
...
static void sub_080C46A0(struct Object2* arg0) {
    ObjectSetFunc(arg0, 6, SparkyShockAttack);
}
