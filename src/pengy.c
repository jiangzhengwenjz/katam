...
const struct AnimInfo gPengyAnimInfo[] = {
    { 0x32C, 0, 0 },
    { 0x32C, 1, 0 },
    { 0x32C, 2, 0 },
    { 0x32C, 3, 0 },
...
static const struct MoveStep gPengyMoveSteps[] = {
...
static void sub_080BAE04(struct Object2* arg0) {
    if (arg0->base.unk62 & 4) {
        if (arg0->unk9E == 0) {
            arg0->unk9F++;
            if (gPengyMoveSteps[arg0->unk9F].unk8 == 0) {
                arg0->unk9F--;
            }
            arg0->unk9E = gPengyMoveSteps[arg0->unk9F].unk8;
            if (gPengyMoveSteps[arg0->unk9F].unk9 != 0xff) {
                arg0->unk83 = gPengyMoveSteps[arg0->unk9F].unk9;
            }
            if (arg0->unk9F != 0) {
                if (gPengyMoveSteps[arg0->unk9F].unk0 != gPengyMoveSteps[arg0->unk9F - 1].unk0) {
                    arg0->base.xspeed = gPengyMoveSteps[arg0->unk9F].unk0;
                    if (arg0->base.flags & 1) {
                        arg0->base.xspeed = -arg0->base.xspeed;
                    }
                }
                if (gPengyMoveSteps[arg0->unk9F].unk2 != gPengyMoveSteps[arg0->unk9F - 1].unk2) {
                    arg0->base.yspeed = gPengyMoveSteps[arg0->unk9F].unk2;
                }
            }
            else {
                arg0->base.yspeed = gPengyMoveSteps[arg0->unk9F].unk2;
        ...
        if (arg0->base.flags & 1) {
            arg0->base.xspeed -= gPengyMoveSteps[arg0->unk9F].unk4;
        }
        else {
            arg0->base.xspeed += gPengyMoveSteps[arg0->unk9F].unk4;
        }
        arg0->base.yspeed += gPengyMoveSteps[arg0->unk9F].unk6;
        arg0->unk9E--;
        if (gPengyMoveSteps[(u8)(arg0->unk9F + 1)].unk8 == 0 && arg0->unk9E == 0) {
...
static void sub_080BAFBC(struct Object2* arg0) {
    ...
    if (arg0->base.unk1 == 1) {
        PengyIceAttack(arg0, arg0->unk85);
        sub_080BB470(arg0);
...
void PengyIceAttack(struct Object2* arg0, u8 arg1) {
