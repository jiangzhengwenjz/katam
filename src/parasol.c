...
extern const s16 gUnk_08355478[];
extern const s8 gUnk_08355490[];
extern const s8 gUnk_083554CF[];
...
static void sub_080C2B28(struct Object2 *r5) {
    ...
    if (r5->object->subtype1 == 2) {
        ...
        r5->base.flags &= ~0x200;
        r4 = (r5->kirby3->base.base.x - r5->base.x) >> 8;
        r1 = (r5->base.y - r5->kirby3->base.base.y) >> 8;
...
static void sub_080C2BB4(struct Object2 *r4) {
    ...
    if (++r4->unk9E > 14) {
        ...
        r4->unk9E = 0;
        r4->unkA0 = r4->kirby3->base.base.x >> 8;
        r4->unkA2 = r4->kirby3->base.base.y >> 8;
    }
