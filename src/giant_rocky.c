...
static void sub_080C046C(struct Object *);
static void sub_080C0514(struct Object *);
static void sub_080C0088(struct Object *);
static void sub_080C04D4(struct Object *);
static void sub_080C0320(void);
static void sub_080C0440(struct Object *);
static void sub_080C0548(struct Object *);
static void sub_080C0578(struct Object *);
static void sub_080C04B8(struct Object *);
static void sub_080C04F8(struct Object *);
static void sub_080C0514(struct Object *);
static void sub_080C056C(struct Object *);
static void sub_080C059C(struct Object *);
...
void *CreateGiantRocky(struct ObjectTemplate *r5, u8 r4)
{
    struct Task *task = TaskCreate(ObjectMain, sizeof(struct Object), 0x1000, TASK_USE_EWRAM, ObjectDestroy);
    struct Object *r0 = TaskGetStructPtr(task), *r6 = r0;
...
static void sub_080BFEA0(struct Object *r4)
{
    r4->base.flags |= 4;
...
static void sub_080BFF74(struct Object *r4)
{
...
static void sub_080C0088(struct Object *r2)
{
...
static void sub_080C00E0(struct Object *r5)
{
...
static void sub_080C0218(struct Object *r5)
{
...
static void sub_080C0440(struct Object *r4)
{
...
static void sub_080C046C(struct Object *r4)
{
...
static void sub_080C04B8(struct Object *r1)
{
    if (++r1->base.counter > 8)
        sub_080BFF74(r1);
}

static void sub_080C04D4(struct Object *r4)
{
...
static void sub_080C04F8(struct Object *r1)
{
    if (++r1->base.counter > 16)
        sub_080C0514(r1);
}

static void sub_080C0514(struct Object *r4)
{
...
static void sub_080C0548(struct Object *r4)
{
...
static void sub_080C056C(struct Object *r0)
{
    r0->base.flags |= 4;
}

static void sub_080C0578(struct Object *r4)
{
...
static void sub_080C059C(struct Object *r0)
{
    r0->base.flags |= 4;
}
