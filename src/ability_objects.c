...
static void AbilityStarDestroy(struct Object2*);
...
const struct AnimInfo gAbilityObjectsAnimInfo[] = {
    { 0x24C, 0, 0 },
    { 0x24C, 0, 0 },
    { 0x24C, 0, 0 },
    { 0x24C, 0, 0 },
...
const struct AnimInfo gAbilityObjectsAnimInfo2[] = {
    { 0x384, 0xB,  0 },
    { 0x384, 0xC,  0 },
    { 0x384, 0xD,  0 },
    { 0x384, 0xE,  0 },
...
const struct AnimInfo gAbilityObjectsAnimInfo3[] = {
    { 0x384, 0x13, 0 },
    { 0x384, 0x14, 0 },
    { 0x384, 0x15, 0 },
    { 0x384, 0x16, 0 },
...
const struct AnimInfo gAbilityObjectsAnimInfo4[] = {
    { 0x384, 0x1D, 0 },
};

const struct AnimInfo gAbilityObjectsAnimInfo5[] = {
    { 0x384, 0x1A, 0 },
    { 0x384, 0x1B, 0 },
    { 0x384, 0x1C, 0 },
};

const struct AnimInfo gAbilityObjectsAnimInfo6[] = {
    { 0x2C3, 4, 0 },
};
...
void *CreateAbilityStar(struct Object *arg0, u8 arg1) {
    ...
    ObjectSetHitbox(&obj->base, -8, -8, 8, 8);
...
static void AbilityStarDestroy(struct Object2* arg0) {
...
static void sub_080A9CEC(struct Object2* arg0) {
    ...
    if (gKirbys[gCurrentPlayerId].base.base.base.roomId == arg0->base.roomId) {
        if ((--arg0->base.counter <= 0xb) && !(arg0->base.counter & 1)) {
            ...
            kirby = &gKirbys[gCurrentPlayerId];
...
static void sub_080AA108(void) {
    ...
    struct Kirby *kirby = &gKirbys[gCurrentPlayerId];
    if (obj->flags & 0x1000) {
...
void *CreateAbilityStatue(struct Object *arg0, u8 arg1) {
    ...
    obj->base.flags |= 0x100;
    obj->base.flags |= 0x400000;
    ObjectSetHitbox(&obj->base, -4, -4, 4, 8);
...
static void sub_080AA618(struct Object2* arg0) {
    if (gMasterSwordActive == 0 && gAIKirbyState >= AI_KIRBY_STATE_UNK1) {
