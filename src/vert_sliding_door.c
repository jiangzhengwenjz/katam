...
void *CreateVertSlidingDoor(struct ObjectTemplate *arg0, u8 arg1) {
    ...
    InitObject(&door->obj, arg0, arg1);
    door->obj.base.flags |= 0x02408940;
    door->obj.base.unk5C |= 0x20;
    door->obj.base.unkC |= 1;
    door->obj.base.unk68 &= ~7;
    door->obj.base.unk5C &= ~7;
    ObjectSetBounds(&door->obj.base, -8, -0x20, 8, 0);
    sub_0803E2B0(&door->obj.base, -8, -0x20, 8, 0);
...
static void VertSlidingDoorIdle(struct VertSlidingDoor *door) {
    ...
    door->obj.base.counter = 0;
    open = *GetStateSlot(STATE_SLOT_ROOM, door->obj.objTemplate->unk4, gCurLevelInfo[door->obj.base.unk56].unk65E);
    if (!(door->unkB4 & 1)) {
        if (open) {
            if (!(door->unkB4 & 2)) {
                door->obj.unk78 = VertSlidingDoorOpen;
                door->obj.unk83 = 1;
                door->unkB7 = 0;
                door->unkB4 |= 1;
                PlaySfx(&door->obj.base, SE_VERT_SLIDING_DOOR_OPEN_CLOSE);
            }
        } else if (door->unkB4 & 2) {
            door->obj.unk78 = VertSlidingDoorClose;
            door->obj.unk83 = 2;
            door->unkB4 |= 1;
            PlaySfx(&door->obj.base, SE_VERT_SLIDING_DOOR_OPEN_CLOSE);
        }
    }
    Macro_080A4728(&door->obj);
}

static void VertSlidingDoorOpen(struct VertSlidingDoor *door) {
    struct Object *obj = &door->obj;
...
void VertSlidingDoorSetFunc(struct VertSlidingDoor *door) {
    door->obj.base.counter = 0;
    door->obj.unk78 = VertSlidingDoorIdle;
    door->unkB4 = 0;
    door->unkB6 = 0;
    door->unkB7 = 0;
}
