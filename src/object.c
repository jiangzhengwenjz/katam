        ...
        if (obj->base.unkC & 0x2000) {
            ...
            if (sub_0803D6B4(obj)) {
                ...
                if (!(obj->base.flags & 0x100)) {
                    ...
                    obj->base.unk62 = 0;
                    if (obj->base.x <= gCurLevelInfo[obj->base.unk56].levelMaxX && obj->base.x >= gCurLevelInfo[obj->base.unk56].levelMinX) {
                        if (obj->base.y <= gCurLevelInfo[obj->base.unk56].levelMaxY && obj->base.y >= gCurLevelInfo[obj->base.unk56].levelMinY) {
...
static void sub_0809A7A4(void) {
    ...
    if (gUnk_08351648[r7->type].numTiles) {
        ...
        {
            r6->x = (r7->base.x >> 8) - (gCurLevelInfo[gUnk_0203AD3C].cameraOffsetX >> 8) + r7->base.objBase54;
            r6->y = (r7->base.y >> 8) - (gCurLevelInfo[gUnk_0203AD3C].cameraOffsetY >> 8) + r7->base.objBase55;
...
static void sub_0809D1E0(struct Object2 *r5) {
    ...
    if (r5->base.x > gCurLevelInfo[r5->base.unk56].levelMaxX || r5->base.x < gCurLevelInfo[r5->base.unk56].levelMinX)
        r5->base.xspeed = 0;
    if (r5->base.y < gCurLevelInfo[r5->base.unk56].levelMinY)
        r5->base.y = gCurLevelInfo[r5->base.unk56].levelMinY;
...
static void sub_0809D7C8(struct Object2 *r8) {
    ...
    if (r8->base.sprite.tilesVram && !(r8->base.flags & 0x400)
        ...
        r7->x = (r8->base.x >> 8) - (gCurLevelInfo[gUnk_0203AD3C].cameraOffsetX >> 8) + r8->base.objBase54;
        r7->y = (r8->base.y >> 8) - (gCurLevelInfo[gUnk_0203AD3C].cameraOffsetY >> 8) + r8->base.objBase55;
...
void sub_0809D8C8(struct ObjectBase *r4) {
    ...
    if ((r2 = r4->x + (r4->unk3E * 0x100)) >= gCurLevelInfo[r4->unk56].levelMaxX) {
        r6 = gCurLevelInfo[r4->unk56].levelMaxX - r2;
        r4->x += r6;
    } else if ((r2 = r4->x + (r4->unk3C * 0x100)) <= gCurLevelInfo[r4->unk56].levelMinX) {
        r6 = gCurLevelInfo[r4->unk56].levelMinX - r2;
        r4->x += r6;
    }
    if ((r2 = r5->y + (r5->unk3F * 0x100)) >= gCurLevelInfo[r5->unk56].levelMaxY) {
        r7 = gCurLevelInfo[r5->unk56].levelMaxY - r2;
        r4->y += r7;
    } else if ((r2 = r5->y + (r5->unk3D * 0x100)) <= gCurLevelInfo[r5->unk56].levelMinY) {
        r7 = gCurLevelInfo[r5->unk56].levelMinY - r2;
        r4->y += r7;
    }
...
bool8 sub_0809D998(struct Object2 *r2) {
    ...
    if (r4 <= gCurLevelInfo[r2->base.unk56].levelMaxX && r4 >= gCurLevelInfo[r2->base.unk56].levelMinX) {
        r2_ = r2->base.y + ((r2->base.unk3F + 1) << 8);
        if (r2_ <= gCurLevelInfo[r2->base.unk56].levelMaxY && r2_ >= gCurLevelInfo[r2->base.unk56].levelMinY) {
...
void sub_0809EF88(struct Object2 *obj) {
    if (!Macro_0810B1F4(&obj->base)
        && obj->base.y + (obj->base.unk3D << 8) >= gCurLevelInfo[obj->base.unk56].levelMaxY + 0x1800) {
        obj->unk80 = 0;
        if (ObjType38To52(obj)) {
