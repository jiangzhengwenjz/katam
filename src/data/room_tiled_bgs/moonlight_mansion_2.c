...
static const u16 sMoonlightMansion2Palette[] = {
    ...
    RGB( 0,  0,  0) | 0x0000, RGB( 2,  8, 17) | 0x0000, RGB( 4,  8, 16) | 0x0000, RGB( 3,  8, 18) | 0x0000, RGB( 6,  8, 14) | 0x0000, RGB( 2,  9, 20) | 0x0000, RGB( 6, 10, 16) | 0x0000, RGB( 2, 11, 22) | 0x0000,
    RGB(10, 11, 10) | 0x0000, RGB( 7, 11, 17) | 0x0000, RGB( 2, 12, 24) | 0x0000, RGB( 8, 12, 19) | 0x0000, RGB(14, 13, 13) | 0x0000, RGB(10, 14, 20) | 0x0000, RGB(12, 16, 20) | 0x8000, RGB(17, 19, 21) | 0x8000,
    RGB( 0,  0,  0) | 0x0000, RGB( 2,  8, 18) | 0x0000, RGB( 6,  8, 14) | 0x0000, RGB( 2, 11, 20) | 0x0000, RGB( 6, 10, 16) | 0x0000, RGB( 4, 12, 19) | 0x0000, RGB( 2, 13, 25) | 0x0000, RGB( 8, 12, 17) | 0x0000,
    RGB( 6, 14, 22) | 0x0000, RGB( 9, 14, 18) | 0x0000, RGB(10, 15, 21) | 0x0000, RGB(14, 17, 20) | 0x8000, RGB(19, 21, 22) | 0x8000, RGB(23, 23, 22) | 0x8000, RGB(26, 26, 23) | 0x8000, RGB(29, 28, 23) | 0x8000,
    ...
    RGB( 0,  0,  0) | 0x0000, RGB( 3,  2, 13) | 0x0000, RGB( 3,  5, 13) | 0x0000, RGB( 4,  7, 14) | 0x0000, RGB( 3,  8, 18) | 0x0000, RGB( 7, 10, 16) | 0x0000, RGB( 9, 11, 11) | 0x0000, RGB( 8, 11, 17) | 0x0000,
...
static const u32 sMoonlightMansion2Tileset[] = INCBIN_U32("graphics/rooms/backgrounds/moonlight_mansion_2/tileset.4bpp.lz");
static const u16 sMoonlightMansion2Tilemap[] = INCBIN_U16("graphics/rooms/backgrounds/moonlight_mansion_2/tilemap.bin");

const struct RoomTiledBG gMoonlightMansion2RoomTiledBG = {
    .width = 45,
    .height = 20,
    .unk4 = 0,
    .unk6 = 0,
    .unk7 = 0,
    .tileset = sMoonlightMansion2Tileset,
    .tilesetSize = 900,
    .palette = sMoonlightMansion2Palette,
    .paletteOffset = 0x60,
    .paletteSize = ARRAY_COUNT(sMoonlightMansion2Palette),
    .tilemap = sMoonlightMansion2Tilemap,
    .unk1C = 0x670000
};
