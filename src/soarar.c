...
extern const struct KirbyMoveScriptStep gUnk_083539B4[];
extern const struct KirbyMoveScriptStep gUnk_083539D4[];
...
static void sub_080AC0A4(void) {
    ...
    if (p->x <= gCurLevelInfo[p->unk56].levelMaxPosition.x
        ...
        ObjectUpdateTerrainCollision(p);
    }
