...
static const s8 gUnk_082DE41C[][4] = {
    {  -0x8,  -0x8,  0x8,  0x8 },
    {  -0x8,  -0x8,  0x8,  0x8 },
    {  -0x8,  -0x8,  0x8,  0x8 },
    {  -0x8,  -0x8,  0x8,  0x8 },
...
static const s16 gUnk_082DE474[] = {
    0x0, 0x1,
    0x2, 0x3,
    0x3, 0x4,
    0x4, 0x4,
...
void* CreateGoalGameBonus(struct ObjectTemplate *arg0, u8 arg1) {
    ...
    ggb = ggb2;
    InitObject(&ggb->obj, arg0, arg1);
    ggb->unkB4 = arg0->subtype1;
    ggb->unkB8 = arg0->subtype2;
    ggb->unkC4 = 0;
    ggb->obj.base.flags |= 0x10008141;
    ggb->obj.base.unk68 &= ~7;
    sub_0803E2B0(&ggb->obj.base, gUnk_082DE41C[ggb->unkB4][0], gUnk_082DE41C[ggb->unkB4][1], gUnk_082DE41C[ggb->unkB4][2], gUnk_082DE41C[ggb->unkB4][3]);
    ObjectSetBounds(&ggb->obj.base, gUnk_082DE41C[ggb->unkB4][0], gUnk_082DE41C[ggb->unkB4][1], gUnk_082DE41C[ggb->unkB4][2], gUnk_082DE41C[ggb->unkB4][3]);
    ggb->obj.unk83 = gUnk_082DE474[ggb->unkB4];
    if (ggb->unkB8 && ggb->unkB4 <= 2)
        ggb->obj.unk83 = 4;
    ObjectInitSprite(&ggb->obj);
    if (ggb->unkB4 > 9 && ggb->unkB4 < 0x14) {
        ggb->obj.base.sprite.unk14 = ((ggb->obj.base.sprite.unk14 >> 6) - 1) << 6;
    }
    gUnk_08351648[ggb->obj.type].unk10(&ggb->obj);

    return ggb;
}

static void sub_0801B394(struct GoalGameBonus *);
static void sub_0801B78C(struct GoalGameBonus *);
static void sub_0801B7E0(struct GoalGameBonus *);

static void (*const gUnk_082DE4A0[])(struct GoalGameBonus *) = {
    sub_0801B394,
    sub_0801B394,
    sub_0801B394,
    sub_0801B394,
...
static const s16 gUnk_082DE4F8[][4] = {
    {   0x0,  0x0, 0x100, 0x0 },
    {   0x0,  0x0, 0x100, 0x0 },
    {   0x0,  0x0, 0x200, 0x0 },
    {   0x0,  0x0, 0x300, 0x0 },
...
static void sub_0801AC98(struct GoalGameBonus *arg0) {
    struct Kirby *kirby = arg0->obj.base.unk6C;
    switch (arg0->unkB4) {
    case 0:
        PlaySfx(&arg0->obj.base, SE_ITEM_COLLECT);
        if (arg0->unkB8) {
            if (kirby->lives > 0xfe) {
                kirby->lives = 0xff;
            }
            ...
            arg0->obj.unk78 = sub_0801B85C;
        }
        else {
            arg0->kirby = kirby;
            arg0->unkC0 = gUnk_08351648[OBJ_SMALL_FOOD].unk4;
            arg0->obj.unk78 = sub_0801B834;
        }
        break;
    case 1:
        PlaySfx(&arg0->obj.base, SE_ITEM_COLLECT);
    ...
    case 18:
    case 19:
        CreateEffectObject(&arg0->obj.base, 0, 0x29b, 0);
        sub_08052E2C(kirby);
        arg0->obj.unk78 = sub_0801B85C;
        break;
    }
...
static inline void GoalGameBonusIncrementXspeed(struct GoalGameBonus *arg0) {
    ...
    if (b)
        sub_0801AC98(arg0);
    a = FALSE;
    if (arg0->obj.base.y > 0x34000 || arg0->obj.base.x < -0x2000)
        a = TRUE;
    else if (arg0->obj.base.x > 0x12000)
        a = TRUE;
    if (a) {
...
static void sub_0801B678(struct GoalGameBonus *arg0) {
    ...
    if (!arg0->unkC0)
        tmp->obj.unk78 = sub_0801B85C;
}

static void sub_0801B78C(struct GoalGameBonus *arg0) {
    if (arg0->obj.base.x > 0x8800) {
        arg0->obj.base.xspeed = -gUnk_082DE4F8[arg0->unkB4][0];
        arg0->obj.unk78 = sub_0801B428;
    }
    else {
        arg0->obj.base.xspeed = gUnk_082DE4F8[arg0->unkB4][0];
        arg0->obj.unk78 = sub_0801B4BC;
    }
}
...
static void sub_0801B7E0(struct GoalGameBonus *arg0) {
    if (arg0->obj.base.x > 0x8800) {
        arg0->obj.base.xspeed = -gUnk_082DE4F8[arg0->unkB4][0];
        arg0->obj.unk78 = sub_0801B550;
    }
    else {
        arg0->obj.base.xspeed = gUnk_082DE4F8[arg0->unkB4][0];
        arg0->obj.unk78 = sub_0801B5E4;
    }
}

static void sub_0801B834(struct GoalGameBonus *arg0) {
    arg0->obj.base.xspeed = 0;
    arg0->obj.base.yspeed = 0;
    arg0->obj.base.flags |= 0x10600;
    arg0->unkC2 = 0;
    arg0->obj.unk78 = sub_0801B678;
}
