...
static void KingGolemHandSlam(void);
...
const struct AnimInfo gKingGolemAnimInfo[] = {
    { 0x303, 0, 0 },
    { 0x303, 1, 0 },
    { 0x303, 2, 0 },
    { 0x303, 3, 0 },
...
const struct AnimInfo gKingGolemAnimInfo2[] = {
    { 0x303, 9, 0 },
};
...
void *CreateKingGolem(struct Object *template, u8 a2)
{
    ...
    ObjectSetHitbox(&kg1->obj2.base, -0x20, 0xC0, 0x20, 0x40);
...
static void sub_080DA2BC(struct KingGolem *kg)
{
    ...
    kg->obj2.kirby3 = FindClosestKirby(&kg->obj2.base);
...
void sub_080DA4B0(struct KingGolem *kg)
{
    ...
    else
    {
        ...
        if (kg->obj2.subtype || kg->obj2.unk80 < gUnk_08351530[0xE][gNumPlayers - 1] >> 1)
...
static void sub_080DA540(struct KingGolem *kg1)
{
    ...
    {
        ++kg2->obj2.unk9F;
        if (kg2->obj2.subtype || kg2->obj2.unk80 < gUnk_08351530[0xE][gNumPlayers - 1] >> 1)
            kg2->obj2.base.counter = 0x10;
        else
            kg2->obj2.base.counter = 0x30;
        if (!(Rand16() & 1) || kg2->obj2.unk9F > 3)
        {
            if (kg2->obj2.unk80 <= gUnk_08351530[0xE][gNumPlayers - 1] >> 1
...
static void sub_080DA768(void)
{
    ...
    else
    {
        ...
        if (kg1->obj2.unk78 == sub_080DB7DC)
        {
            ...
            kg2->unkBC = 0;
            obj4->unk8 = 1;
            if (kg1->obj2.subtype || kg1->obj2.unk80 < gUnk_08351530[0xE][gNumPlayers - 1] >> 1)
            {
            ...
            gCurTask->main = KingGolemHandSlam;
        }
        ...
        if (obj4->unk4 == 0x12)
        {
            if (kg2->unkBD)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    if (kg1->obj2.unk80 < gUnk_08351530[0xE][gNumPlayers - 1] >> 1)
                    {
                        if (kg1->obj2.subtype)
                            sub_080DB1B8(kg1, 1);
                        else
...
static void KingGolemSpawnGolem(struct KingGolem *kg1)
{
    struct KingGolem *kg2 = kg1;
    s32 x, y;
    u8 r;
