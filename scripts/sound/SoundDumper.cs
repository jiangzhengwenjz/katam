...
namespace dump_sound
{
    ...
    {
        private static int MPlayTableAdr = 0x08B59EA0;
        private static int NumMPlayers = 4;
        private static int SongTableAdr = MPlayTableAdr + NumMPlayers * 12;
        private static int NumSongs = 620;

        private static int VoiceGroupEndAdr = 0x08B59D40;
